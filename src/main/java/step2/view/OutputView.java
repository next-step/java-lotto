...
public class OutputView {
    ...
    public static void outPutProfit(double Profit, Map<String, Integer> winningResult) {
        System.out.println(String.format("%d개 일치 (%d원)- %d개", WinningAmountByRank.FOURTH.getRank(),
                WinningAmountByRank.FOURTH.getAmount(), winningResult.getOrDefault(WinningAmountByRank.FOURTH.getKey(), 0)));

        System.out.println(String.format("%d개 일치 (%d원)- %d개", WinningAmountByRank.THIRD.getRank(),
                WinningAmountByRank.THIRD.getAmount(), winningResult.getOrDefault(WinningAmountByRank.THIRD.getKey(), 0)));
