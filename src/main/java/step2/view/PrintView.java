...
public class PrintView {
    ...
    public static void numberOfMatches(Map<Match, Integer> numberOfMatches) {
        System.out.println("3개 일치 (5000원) - " + numberOfMatches.get(match(3, false)) + "개");
        System.out.println("4개 일치 (50000원) - " + numberOfMatches.get(match(4, false)) + "개");
        System.out.println("5개 일치 (1500000원) - " + numberOfMatches.get(match(5, false)) + "개");
        System.out.println("5개 일치 (30000000원) - " + numberOfMatches.get(match(5, true)) + "개");
        System.out.println("6개 일치 (2000000000원) - " + numberOfMatches.get(match(6, false)) + "개");
    }
