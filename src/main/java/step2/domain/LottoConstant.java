...
public class LottoConstant {
    ...
    public static final int LOTTO_NUMBER_RANGE = 45;
    public static final String VALID_LOTTO_NUMBER_LENGTH_MESSAGE = "로또 번호는 6개여야 합니다.";
    public static final String VALID_LOTTO_NUMBER_DUPLICATE_MESSAGE = "로또 번호는 중복일 수 없습니다.";
    public static final String VALID_LOTTO_PRICE_MESSAGE = "최소 구매 금액은 1000원 입니다.";
    public static final String INPUT_MONEY_MESSAGE = "금액을 입력해 주세요.";
