...
public class Calculator {
    ...
    public static int calculate(int number1, int number2, String operator) {
        if (operator.equals(PLUS_SYMBOL)) return sum(number1, number2);
        if (operator.equals(MINUS_SYMBOL)) return subtract(number1, number2);
        if (operator.equals(MULTIPLY_SYMBOL)) return multiply(number1, number2);
        if (operator.equals(DIVIDE_SYMBOL)) return divide(number1, number2);
