...
public class LottoGame {
	...
	public LottoGame(int price, int manualLottoCount) {
		validPrice(price);
	...
	public Lottos getAllLottos(List<Lotto> manualLottos) {
		return lottos.getAllLottos(price / LOTTO_PRICE, manualLottos);
	}
