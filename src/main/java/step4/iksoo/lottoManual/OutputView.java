...
public class OutputView {
    ...
    public static void printAskOrderPrice() {
        System.out.println("구입금액을 입력해 주세요.");
    }

    public static void printAskManualOrder() {
        System.out.println("수동으로 구매할 로또 수를 입력해 주세요.");
    }

    public static void printAskManualNumbers() {
        System.out.println("수동으로 구매할 번호를 입력해 주세요.");
    }

    public static void printOrderCheck(int totalLottoes, int manualLottoes) {
        System.out.println("수동으로 " + manualLottoes + "장, 자동으로 " + (totalLottoes-manualLottoes) + "개를 구매했습니다.");
    }
