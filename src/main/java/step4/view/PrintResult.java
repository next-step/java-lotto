...
import step4.domain.LottoFactory;
import step4.domain.WinningPrice;
...
public class PrintResult {
    ...
    public static void printBuyQuantity(int autoQuantity, int manualQuantity) {
    ...
    public static void pringString(String value) {
