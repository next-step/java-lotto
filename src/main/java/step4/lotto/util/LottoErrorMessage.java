...
public class LottoErrorMessage {
    ...
    private static String LOTTO_RANK_EXCEPTION = "맞는 횟수의 갯수는 3개부터 7개까지 가능합니다.";
    ...
    private static String LOTTO_COMPARE_MANUAL_COUNT_WITH_INPUT_LOTTO_NUMBER = "입력한 로또번호들의 갯수와 구매한 갯수가 다릅니다.";
    ...
    public static String getLottoCompareManualCountWithInputLottoNumber() {
        return LOTTO_COMPARE_MANUAL_COUNT_WITH_INPUT_LOTTO_NUMBER;
    }
