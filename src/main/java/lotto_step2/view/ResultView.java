...
public class ResultView {
    ...
    public void printGameResult (List<PrizeMachine> gameResults) {
        ...
        System.out.println("\n당첨 통계\n---------");
        System.out.println("3개 일치 (5000원)- " + matches.get(PrizeMachine.FIFTH) + "개");
        System.out.println("4개 일치 (50000원)- " + matches.get(PrizeMachine.FOURTH) + "개");
        System.out.println("5개 일치 (1500000원)- " + matches.get(PrizeMachine.THIRD) + "개");
        System.out.println("5개 일치, 보너스볼 일치 (3000000원)- " + matches.get(PrizeMachine.SECOND) + "개");
