...
public class ResultView {
	...
	public static final String INTRO_OF_FIX_MATCHED_AND_BONUS_MATCHED = "5개 일치, 보너스 볼 일치(30000000원)- ";
	...
	public void drawResult(LottoReport lottoResultReport) {
		...
		System.out.println(INTRO_OF_THREE_MATCHED + lottoResultReport.lottoMatchCount(3, false) + count);
		System.out.println(INTRO_OF_FOUR_MATCHED + lottoResultReport.lottoMatchCount(4, false) + count);
		System.out.println(INTRO_OF_FIX_MATCHED + lottoResultReport.lottoMatchCount(5, false) + count);
		System.out.println(INTRO_OF_FIX_MATCHED_AND_BONUS_MATCHED + lottoResultReport.lottoMatchCount(5, true) + count);
		System.out.println(INTRO_OF_SIX_MATCHED + lottoResultReport.lottoMatchCount(6, false) + count);
