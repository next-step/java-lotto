...
public class ResultView {
    public static void printLottoResults(LottoResult result) {
        ...
        System.out.println("4개 일치 (50000원) - " + result.getRankCount(Rank.FOURTH));
        System.out.println("5개 일치 (1500000원) - " + result.getRankCount(Rank.THIRD));
        System.out.println("5개 일치, 보너스 볼 일치(30000000원) - " + result.getRankCount(Rank.SECOND));
