...
public class LottoConfig {
    ...
    static final String INPUT_BONUS_BALL = "보너스 볼을 입력해 주세요.";
    ...
    static final String RESULT_FIFTH = "3개 일치 (5000원)- %d개";
    static final String RESULT_FORTH = "4개 일치 (50000원)- %d개";
    static final String RESULT_THIRD = "5개 일치 (1500000원)- %d개";
    static final String RESULT_SECOND = "5개 일치, 보너스 볼 일치(30000000원) - %d개";
    static final String RESULT_FIRST = "6개 일치 (2000000000원)- %d개";
