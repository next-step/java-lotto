...
public class ResultView {
    ...
    private static final String FIVE_MATCHES_WITH_BONUS_MESSAGE = "5개 일치, 보너스 볼 일치(30000000원)- ";
    ...
    public static void printWinningStatistics(WinningStatistics statistics) {
        ...
        System.out.printf((FIVE_MATCHES_WITH_BONUS_MESSAGE) + "%d" + COUNT_UNIT + "%n", statistics.getRankCount(Rank.FIVE_MATCHES_WITH_BONUS));
