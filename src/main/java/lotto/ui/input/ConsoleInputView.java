...
public class ConsoleInputView implements InputView{
    ...
    public static final String READ_BONUS_LOTTO_MESSAGE = "보너스 볼을 입력해 주세요.";
    ...
    public WinningLotto readWinningLotto() {
        ...
        System.out.println(READ_BONUS_LOTTO_MESSAGE);
        String bonusText = scanner.nextLine();
        return new WinningLotto(lottoText, bonusText);
    }
}
