...
## TODO
- [ ] 유저로부터 구입금액입력을 받아야한다.
- [ ] 유저로부터 입력이 공백이거나 null이면 0을 구입금액을 0으로 인식한다.
- [ ] 숫자 이외의 값, 혹은 음수를 입력받은 경우에는 IllegalArgumentException을 던진다. 
...
- [ ] 지난주 당첨번호가 숫자 이외의 값, 혹은 음수를 입력받은 경우에는 IllegalArgumentException을 던진다.
