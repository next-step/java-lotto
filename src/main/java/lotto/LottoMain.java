...
public class LottoMain {
    ...
    public static void main(String[] arg) {
        ...
        int lottoAutoCount = createLottoAutoGameCount(inputLottoGamePrice,inputLottoManualCount);
        LottoGamesExecute lottoGamesExecute = new LottoGamesExecute();
        lottoGamesExecute.manualLottoNumbers(inputLottoManualNumbers);
        List<Lotto> lottos = lottoGamesExecute.extractLottoNumbers(lottoAutoCount);
    ...
    static int createLottoAutoGameCount(int inputLottoGames, int inputLottoManualGames) {
        ...
        return inputLottoGames / lottoOneGamePrice - inputLottoManualGames;
    }
