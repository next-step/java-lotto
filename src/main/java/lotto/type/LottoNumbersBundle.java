...
public class LottoNumbersBundle {
  ...
  public static LottoNumbersBundle fromAutoGenerated(int lottoCount, LottoCreateStrategy lottoCreateStrategy) {
    List<LottoNumbers> bundle = IntStream.range(0, lottoCount)
        .mapToObj(i -> LottoNumbers.generate(lottoCreateStrategy))
        .collect(Collectors.toList());
    return new LottoNumbersBundle(bundle);
  }

  public static LottoNumbersBundle fromManualAndAutoGenerated(
    ...
    return new LottoNumbersBundle(res);
  }
