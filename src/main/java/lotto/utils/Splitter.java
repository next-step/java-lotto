...
public class Splitter {
    ...
    public static List<LottoNumber> split(String answerLottoNumbers) {
        List<LottoNumber> lottoNumbers = makeLottoNumbers(answerLottoNumbers);
    ...
    private static List<LottoNumber> makeLottoNumbers(String answerLottoNumbers) {
