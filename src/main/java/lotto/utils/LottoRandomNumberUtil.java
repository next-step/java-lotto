...
public class LottoRandomNumberUtil {
    ...
    private static final List<Integer> numbers = IntStream.range(BOUND_MIN, BOUND_MAX).boxed().collect(Collectors.toList());
    ...
    public static List<Integer> lottoNumbers() {
        ...
        List<Integer> lottoNumbers = numbers.subList(0, NUMBER_OF_LOTTO_NUMBER);
