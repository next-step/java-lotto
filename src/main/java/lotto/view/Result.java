...
public class Result {
    ...
    private static final String LOTTO_AMOUNT_MESSAGE = "수동으로 %d장, 자동으로 %d개를 구매했습니다.";
    ...
    public static void printLottoAmount(int amount, int manual) {
        System.out.println(String.format(LOTTO_AMOUNT_MESSAGE, manual, (amount - manual)));
    }
