...
public class Output {
    ...
    public void printWinningResult(LottoResultDto lottoResultDto) {
        ...
        System.out.println("---------");
        System.out.println("3개 일치 (" + ConstUtils.WIN_THREE + "원)- " + lottoResultDto.getMatchThreeNumbers() + "개");
        System.out.println("4개 일치 (" + ConstUtils.WIN_FOUR + "원)- " + lottoResultDto.getMatchFourNumbers() + "개");
        System.out.println("5개 일치 (" + ConstUtils.WIN_FIVE + "원)- " + lottoResultDto.getMatchFiveNumbers() + "개");
        System.out.println("6개 일치 (" + ConstUtils.WIN_SIX + "원)- " + lottoResultDto.getMatchSixNumbers() + "개");
