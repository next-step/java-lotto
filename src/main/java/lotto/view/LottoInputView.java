...
public class LottoInputView {
    ...
    private static final String INPUT_LOTTO_AMOUNT_MESSAGE = "수동으로 구매할 로또 수를 입력해 주세요.";
    private static final String INPUT_LOTTO_NUMBER_MESSAGE = "수동으로 구매할 번호를 입력해 주세요.";
