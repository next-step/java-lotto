...
public class ResultView {
    ...
    public static void printQuantity(LottoFactory lottoFactory, int autoQuantity) {
        System.out.println("수동으로 " + lottoFactory.getManualQuantity() + "장, 자동으로" + autoQuantity + "개를 구매했습니다.");
    }
