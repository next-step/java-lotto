...
public class ResultView {
    ...
    private static final String OUTPUT_FIVE_MATCH_BONUS_CASE = "5개 일치, 보너스 볼 일치(30000000원) - %d개\n";
    ...
    public void outputStatistics(WinStatistics winStatistics, float rateOfReturn) {
        ...
        printf(OUTPUT_THREE_MATCH_CASE, winStatistics.countByRank(Rank.FIFTH));
        printf(OUTPUT_FOUR_MATCH_CASE, winStatistics.countByRank(Rank.FOURTH));
        printf(OUTPUT_FIVE_MATCH_CASE, winStatistics.countByRank(Rank.THIRD));
        printf(OUTPUT_FIVE_MATCH_BONUS_CASE, winStatistics.countByRank(Rank.SECOND));
        printf(OUTPUT_SIX_MATCH_CASE, winStatistics.countByRank(Rank.FIRST));
