...
public class ResultView {
    ...
    public void printPickedLottoNumbers(LottoCount lottoCount, Lottos lottos) {
        System.out.printf("수동으로 %d장, 자동으로 %d개를 구매했습니다.%n", lottoCount.getManualCount(), lottoCount.getAutoCount());
