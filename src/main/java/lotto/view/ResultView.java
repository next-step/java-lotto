...
public final class ResultView {
	...
	public static void printStatistics(final LottoResult lottoResult, final int price) {
		...
		System.out.println("---------");
		System.out.println("3개 일치 (5000원)- " + lottoResult.rankCount(Rank.RANK4) + "개");
		System.out.println("4개 일치 (50000원)- " + lottoResult.rankCount(Rank.RANK3) + "개");
		System.out.println("5개 일치 (1500000원)- " + lottoResult.rankCount(Rank.RANK2) + "개");
