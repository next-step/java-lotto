...
public class ResultView {
    ...
    public static void printWinningStatus(WinningStatus winningStatus) {
        ...
        System.out.println("---------");
        System.out.println("3개 일치 (5000원) - " + winningStatus.getCountOfPrize(FIFTH_PRIZE) + "개");
        System.out.println("4개 일치 (50000원) - " + winningStatus.getCountOfPrize(FOURTH_PRIZE) + "개");
        System.out.println("5개 일치 (1500000원) - " + winningStatus.getCountOfPrize(THIRD_PRIZE) + "개");
        System.out.println("5개 일치, 보너스 볼 일치(30000000원) - " + winningStatus.getCountOfPrize(SECOND_PRIZE) + "개");
