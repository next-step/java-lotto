...
public class ResultView {
    ...
    private final static String LAST_WEEK = "지난 주 당첨 번호를 입력해 주세요.";
    ...
    public LottoTicket lottoTicketLastWeekResultView() {
        System.out.println(LAST_WEEK);
        LottoTicket lastWeekWinningNumbers = lotto.getLastWeekWinningNumbers();
