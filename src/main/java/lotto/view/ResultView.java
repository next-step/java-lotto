...
public class ResultView {
    ...
    private static final String PRINT_MANUAL_LOTTO_COUNT = "수동으로 구매할 로또 수를 입력해 주세요.";
    private static final String PRINT_MANUAL_LOTTO_INPUT = "수동으로 구매할 번호를 입력해 주세요";
    private static final String PRINT_BUY_LOTTO_COUNT = "수동으로 %d장, 자동으로 %d개를 구매했습니다.\n";
    ...
    public static void printManualLottoCount() {
        System.out.println(PRINT_MANUAL_LOTTO_COUNT);
    }

    public static void printManualLottoInput() {
        System.out.println(PRINT_MANUAL_LOTTO_INPUT);
    }
    ...
    private static void printBuyLottoCount(LottoCount lottoCount) {
        System.out.printf(PRINT_BUY_LOTTO_COUNT, lottoCount.getManualCount(), lottoCount.getAutoCount());
    }
