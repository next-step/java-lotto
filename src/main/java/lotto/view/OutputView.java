...
public class OutputView {
    ...
    public void showResult(PrizeWinningResult result) {
        ...
        writer.println("-----------");
        writer.println(MessageFormat.format("3개 일치 ({0}) - {1}개", result.getFourthPrizeMoney(), result.getFourthPrizeCount()));
        writer.println(MessageFormat.format("4개 일치 ({0}) - {1}개", result.getThirdPrizeMoney(), result.getThirdPrizeCount()));
        writer.println(MessageFormat.format("5개 일치 ({0}) - {1}개", result.getSecondPrizeMoney(), result.getSecondPrizeCount()));
