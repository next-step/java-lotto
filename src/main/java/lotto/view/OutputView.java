...
public class OutputView {
    ...
    public static void printPurchaseTicketCount(int ticketCount) {
    ...
    public static void printLottoResults(Map<WinningPrize, Integer> lottoResult) {
    ...
    public static void printPrizeRate(int calculatePrizeRate) {
