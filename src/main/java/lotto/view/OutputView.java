...
public class OutputView {
    ...
    public void printRankResult(Prize prize, RankDTO rankDto) {
        ...
        System.out.printf(TOTAL_RATIO_MESSAGE,
            prize.getPrizeRatio(rankDto.getRankResult(), rankDto.getPrizeValue()));
    }
