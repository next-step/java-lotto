...
public class InputView {
    ...
    private static final int BONUS_BALL_SIZE = 1;
    ...
    private static final String BONUS_BALL_SIZE_ERROR_LOG = "보너스 볼은 " + BONUS_BALL_SIZE + "자리여야 합니다.";
    ...
    private static void checkOneNumber(String input) {
        if (input.length() != BONUS_BALL_SIZE) {
            throw new IllegalArgumentException(BONUS_BALL_SIZE_ERROR_LOG);
        }
    }
}
