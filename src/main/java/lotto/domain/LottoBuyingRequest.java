...
public class LottoBuyingRequest {
	...
	public boolean equals(Object o) {
		...
		LottoBuyingRequest that = (LottoBuyingRequest)o;

		return autoLottoCount == that.autoLottoCount && Objects.equals(money, that.money)
			&& Objects.equals(manualLottoNumbers, that.manualLottoNumbers);
	}

	@Override
	public int hashCode() {
		return Objects.hash(money, manualLottoNumbers, autoLottoCount);
	}
}
