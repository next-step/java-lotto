...
public class Lotto {
	...
	private void printLottoNumberUI(List<List> autoGeneratedLottoNumbers) {
		inputView.printLottoNumber(autoGeneratedLottoNumbers);
		System.out.println();
	}
	...
	private void printResultUI(LottoResult lottoResult) {
		resultView.printMatchUI(lottoResult);
