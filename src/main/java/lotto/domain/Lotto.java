...
public class Lotto {
	...
	public void start() {
		...
		for (List<Integer> autoGeneratedLotto : autoGeneratedLottos) {
			int result = calculatePrizeStatistics(lastWeekPrizeNumbers, autoGeneratedLotto);
		}
	}
	...
	private void printLastPrizeInput() {
		...
		convertStringToInteger(lastWeekPrizeNumber);
		System.out.println();
	}
	...
	public List<Integer> convertStringToInteger(String lastWeekPrizeNumberInput) throws IllegalArgumentException {
		...
		Set<Integer> validateSet = new HashSet<Integer>(lastWeekPrizeNumberList);
	...
	public int calculatePrizeStatistics(List<Integer> lastWeekPrizeNumberList, List<Integer> autoGeneratedLotto) {
		int matchCount = 0;
