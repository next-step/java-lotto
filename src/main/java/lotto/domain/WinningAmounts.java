...
public class WinningAmounts {
    ...
    public static final int MATCHING_COUNT_FOUR = 4;
    ...
    public static final long AMOUNT_FOUR_MATCHED = 50_000L;
    ...
    public WinningAmounts() {
        this.amounts.put(MATCHING_COUNT_THREE, AMOUNT_THREE_MATCHED);
        this.amounts.put(MATCHING_COUNT_FOUR, AMOUNT_FOUR_MATCHED);
