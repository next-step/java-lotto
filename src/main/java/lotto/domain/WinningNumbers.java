...
public class WinningNumbers {
    ...
    private String removeBlank(String inputNumbers) {
        return inputNumbers.replaceAll(SPACES, EMPTY_STRING);
    }

    private void validateInputFormat(String numbers) {
    ...
    private List<String> splitNumber(String winningNumbers) {
    ...
    private void validateWinningNumberRange(List<String> winningNumbers) {
