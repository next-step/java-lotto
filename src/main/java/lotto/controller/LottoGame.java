...
public class LottoGame {
    ...
    public static void main(String[] args) {
        ...
        Lottos lottos = new Lottos(lottoMachine.generateLottos(InputView.getCustomLottos(customLottoCount)));
        ResultView.printPurchaseNumber(lottos.getLottos().size());             // 개를 구입했습니다.
        ResultView.printGeneratedLottos(lottos.getLottos());                   // 생성된 로또 목록
        ...
        Map<WinningType, Integer> matchResult = lottos.calculateResult(winningLotto); // 로또 결과 계산
