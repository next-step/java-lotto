...
public class ManualLottoMain {
    ...
    public static void main(String[] args) {
        try {
            ...
            List<Lotto> ManualAndAutoLottoTickets = lottoGenerator.purchaseManualAndAutoLottoTickets(numberOfTicket, numberOfManualLotto);
            LottoTickets purchasedLottoTickets = LottoTickets.of(ManualAndAutoLottoTickets);
            ...
            // 정답로또를 생성
            WinnerLotto winnerLotto = WinnerLotto.of(bonusNumber,winningLotto);
