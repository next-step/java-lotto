...
public class LottoGameController {
  ...
  public void runGame() {
    ...
    List<Integer> lastWeekLottoNumber = drawWinningLotto();
    List<LottoNumber> lottoNumbers = new ArrayList<>();
    for (int lottoNumber : lastWeekLottoNumber) {
      lottoNumbers.add(new LottoNumber(lottoNumber));
    }
    Lotto lastLotto = new Lotto(new LottoNumberList(lottoNumbers));
    LottoNumber bonusBall = new LottoNumber(drawBonusBall());
    LastWinningLotto lastWeekWinningLotto = new LastWinningLotto(lastLotto,bonusBall);
