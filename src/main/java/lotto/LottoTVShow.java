...
public class LottoTVShow {
	...
	private List<LottoMatchResult> compareLastWeekPrizeNumberWithAutoGeneratedLottoNumber(GeneratedLotto lastWeekPrizeNumbers, List<GeneratedLotto> generatedLottos, int bonusNumber) {
