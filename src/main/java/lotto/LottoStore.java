...
import lotto.domain.strategy.FixedPoolNumberGenerateStrategy;
...
public class LottoStore {
  ...
  public static void main(String[] args) {
    ...
    LottoMachine lottoMachine = new LottoMachine(new GameGenerator(orderSheet, new FixedPoolNumberGenerateStrategy()));
