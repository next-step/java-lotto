...
public class CalculatorService {
    ...
    public int calculate(String input) {
        ...
        return operatorCalculate(getNumbers(splitResult), getOperators(splitResult));
    }
    ...
    private List<Number> getNumbers(List<String> splitResult) {
    ...
    private List<Operator> getOperators(List<String> splitResult) {
        return splitResult.stream()
    ...
    private int operatorCalculate(List<Number> numbers, List<Operator> operators) {
