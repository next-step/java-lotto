...
public class Calculator
{
    ...
    public static final String ERROR_NULL_OR_EMPTY_MESSAGE = "NULL 또는 공백은 입력할 수 없습니다.";
    public static final String ERROR_FIRST_NOT_NUMBER_MESSAGE = "코드의 시작이 숫자가 아닙니다.";
