public class ResultView {
    ...
    public static void printTotalCandidates(int manualLottoCount, int autoLottoCount, Candidates candidates) {
        System.out.println("수동으로 " + manualLottoCount + "장, 자동으로 " + autoLottoCount + "개를 구매했습니다.");

        System.out.println(candidates.toString());
    }

    public static void printStatistics(CandidateRanks ranks) {
