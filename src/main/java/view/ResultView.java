...
public class ResultView {
    ...
    public static void printLottoResult(Lottos lottos, FirstPlaceLotto firstPlaceLotto) {
        ...
        System.out.println("4개 일치 (50000원)- " + map.get(LottoRankResult.FOURTH) + "개");
        System.out.println("5개 일치 (1500000원)- " + map.get(LottoRankResult.THIRD) + "개");
        System.out.println("5개 일치, 보너스 볼 일치(30000000원)- " + map.get(LottoRankResult.SECOND) + "개");
        System.out.println("6개 일치 (2000000000원)- " + map.get(LottoRankResult.FIRST) + "개");
