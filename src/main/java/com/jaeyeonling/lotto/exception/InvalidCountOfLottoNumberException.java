...
public class InvalidCountOfLottoNumberException extends IllegalArgumentException {
    ...
    public InvalidCountOfLottoNumberException(final int inputCountOfLottoNumber) {
        super(String.format(ERROR_MESSAGE, Lotto.COUNT_OF_LOTTO_NUMBER, inputCountOfLottoNumber));
    }
}
