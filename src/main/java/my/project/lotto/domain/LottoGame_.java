...
public enum LottoGame_ {
    ...
    LottoGame_(int title, int num, int count) {
        this.title = title;
        this.num = num;
        this.count = count;
    }

    /*public static Win findRank(Lotto record, List<Integer> winningNumbers) {
...
/*
    ...
    private static int hasWinNumber(Lotto record, List<Integer> winningNumbers) {
