...
public class LottoController {
    ...
    public void run() {
        ...
        TicketBox manualTicketBox = getTicketBox(manualLottoPurchasePrice, manualLottoMachine);
        TicketBox automaticTicketBox = getTicketBox(automaticLottoPurchasePrice, automaticLottoMachine);
    ...
    private static TicketBox getTicketBox(PurchasePrice purchasePrice, LottoMachine lottoMachine) {
