...
public class LottoTest {
    ...
    public void matching_count() {
        ...
        List<LottoNumber> lottoResultNumbers = List.of(lottoResultNumber1, lottoResultNumber2, lottoResultNumber3,lottoResultNumber4,lottoResultNumber5,lottoResultNumber6);
        ...
        List<LottoNumber> lottoNumbers = List.of(lottoNumber1, lottoNumber2, lottoNumber3,lottoNumber4,lottoNumber5,lottoNumber6);
