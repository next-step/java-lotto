...
class LottoOrderGroupStaticsTest {
	...
	public void 수익률_계산_자연수_소숫 () {
		...
		lottos.add(new Lotto(Arrays.asList(17, 18, 19, 20, 21, 22)));
		lottos.add(new Lotto(Arrays.asList(23, 24, 25, 26, 27, 28)));
		lottos.add(new Lotto(Arrays.asList(29, 30, 31, 32, 33, 34)));
		lottos.add(new Lotto(Arrays.asList(35, 36, 37, 38, 39, 40)));
