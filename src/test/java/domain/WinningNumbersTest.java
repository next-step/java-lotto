...
public class WinningNumbersTest {
    ...
    public void initWinningNumbers() {
        this.winningNumbers = new WinningNumbers(Arrays.asList(1, 2, 3, 4, 5, 6), 7);
    }
    ...
    public void 로또_5개미만_일치_보너스볼_일치() {
        ...
        assertThat(this.winningNumbers.isContainsBonusBall(7, lotto)).isFalse();
    }

    @Test
    public void 로또_5개_일치_보너스볼_불일치() {
        Lotto lotto  = new Lotto(new LottoNumbers(Arrays.asList(1, 2, 3, 4, 5, 15)));
        assertThat(this.winningNumbers.isContainsBonusBall(40, lotto)).isFalse();
    }

    @Test
    public void 로또_5개_일치_보너스볼_일치() {
        Lotto lotto  = new Lotto(new LottoNumbers(Arrays.asList(1, 2, 3, 4, 5, 7)));
        assertThat(this.winningNumbers.isContainsBonusBall(5, lotto)).isTrue();
    }

    @Test
    public void 로또_6개_일치() {
        Lotto lotto  = new Lotto(new LottoNumbers(Arrays.asList(1, 2, 3, 4, 5, 6)));
        assertThat(this.winningNumbers.isContainsBonusBall(6, lotto)).isFalse();
    }
}