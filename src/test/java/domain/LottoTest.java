...
class LottoTest {
    ...
    void checkLottoNumbers() {
        ...
        //when
        int correctNumberCount = lotto.countMatchCount(new ArrayList<>(Arrays.asList(3, 4, 5, 6, 7, 8)));
    ...
    void checkNonLottoNumbers() {
        ...
        //when
        int correctNumberCount = lotto.countMatchCount(new ArrayList<>(Arrays.asList(7, 8, 9, 10, 11, 12)));
