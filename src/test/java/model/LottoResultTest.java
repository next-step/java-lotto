...
public class LottoResultTest {
    ...
    @BeforeEach
    public void init() {
        winningLotto = new WinningLotto(new Lotto("1, 2, 3, 4, 5, 6", LottoType.WIN), new LottoNumber(40));
    ...
    public void totalProfitTest1() {
        List<Lotto> lottos = new ArrayList<>(List.of(new Lotto("1, 2, 3, 4, 5, 6", LottoType.AUTO)));
    ...
    public void totalProfitTest2() {
        List<Lotto> lottos = new ArrayList<>(List.of(new Lotto("10, 11, 12, 13, 14, 15", LottoType.AUTO)));
        LottoResult result = LottoResult.of(winningLotto, new Lottos(lottos), price);
