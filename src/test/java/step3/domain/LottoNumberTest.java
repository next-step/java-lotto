...
public class LottoNumberTest {
    ...
    public void 로또_지난_당첨번호_null(String lottoNumbers) {
        assertThatThrownBy(() -> new LottoNumber(lottoNumbers, lottoNumbers))
    ...
    public void 로또_지난_당첨번호_갯수_유효체크(String lottoNumbers) {
        assertThatThrownBy(() -> new LottoNumber(lottoNumbers, "8"))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    public void 보너스번호_숫자아닌경우_예외처리(String bonusNumber) {
        assertThatThrownBy(() -> new LottoNumber("1,2,3,4,5,6", bonusNumber))
                .isInstanceOf(IllegalArgumentException.class)
