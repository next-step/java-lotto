...
public class LottoWinningNumbersTest {
    ...
    public void 입력받은_당첨번호_자릿수_확인() {
        ...
        assertThatIllegalArgumentException().isThrownBy(() -> Lotto.checkWinningNumberLength(winningNumbers));
    }
    ...
    public void 당첨번호_범위_확인() {
        ...
        assertThatIllegalArgumentException().isThrownBy(() -> Lotto.checkWinningNumberRange(winningNumbers));
    }
    ...
    public void 당첨번호_중복_확인() {
        ...
        assertThatIllegalArgumentException().isThrownBy(() -> Lotto.checkOverlapWinningNumber(winningNumbers));
    }

    @DisplayName("보너스번호 중복/ 보너스번호 범위 확인")
    @Test
    public void 보너스번호_유효성_확인() {
        Lotto.lottoBonusNumber = 10;
        assertThatIllegalArgumentException().isThrownBy(() -> LottoNo.checkOverlapBonusNumber(10));
    }
}
