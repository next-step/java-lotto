...
public class LottoWinnerTest {
    ...
    void getTotalPriceTest(String winnerNumber, int expectedPrice) {
        LottoWinner lottoWinner = new LottoWinner(List.of(new Lotto(new LottoNumbers(List.of(18,1,24,25,20,21)))), winnerNumber, new WinnerBoard(), 45);
    ...
    void getWinnerScoreTest(String winnerNumbers, String expectedRank) {
        LottoWinner lottoWinner = new LottoWinner
                (List.of(new Lotto(new LottoNumbers(List.of(1,2,3,17,16,15)))), winnerNumbers, new WinnerBoard(), 45);
        WinnerBoard winnerBoard = lottoWinner.getWinnerNumberMatchCount();

        assertThat(winnerBoard.winnerBoard.get(expectedRank)).isEqualTo(1);
    }
    ...
    void validateBonusNumberTest(String winNumbers, int bonusNumber) {
        assertThatThrownBy(() -> new LottoWinner(List.of(new Lotto(new LottoNumbers(List.of(18,1,24,25,20,21)))), winNumbers, new WinnerBoard(), bonusNumber))
