...
public class LottoTicketFixtures {
    ...
    public static final LottoTicket LOTTO_TICKET_234568 = new LottoTicket(
            Arrays.asList(
                    new LottoNumber(2), new LottoNumber(3), new LottoNumber(4),
                    new LottoNumber(5), new LottoNumber(6), new LottoNumber(8)
            )
    );
    ...
    public static final LottoTicket LOTTO_TICKET_456789 = new LottoTicket(
            Arrays.asList(
                    new LottoNumber(4), new LottoNumber(5), new LottoNumber(6),
