...
public class InputValidatorTest {
    ...
    void invalidValueTest(String invalidValue) {
        assertThatThrownBy(() -> inputValidator.validate(invalidValue)).isInstanceOf(RuntimeException.class);
    }
    ...
    void isNullTest(String nullValue) {
        assertThat(inputValidator.isNull(nullValue)).isEqualTo("0");
    }
    ...
    void isEmpty(String emptyValue) {
        assertThat(inputValidator.isEmpty(emptyValue)).isEqualTo("0");
    }
}
