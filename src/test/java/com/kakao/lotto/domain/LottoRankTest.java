...
class LottoRankTest {
    ...
    private static Stream<Arguments> lottoRanks() {
        return Stream.of(
                ...
                Arguments.arguments(5, true, LottoRank.BONUS),
                Arguments.arguments(5, false, LottoRank.SECOND),
                Arguments.arguments(4, true, LottoRank.THIRD),
                Arguments.arguments(4, false, LottoRank.THIRD),
                Arguments.arguments(3, true, LottoRank.FOURTH),
                Arguments.arguments(3, false, LottoRank.FOURTH),
