...
public class LottoMachineTest {
    ...
    void 로또_자동_생성_기능_테스트() {
        ...
        BuyLottos buyLottos = lottoMachine.createAutoLottos(PurchaseQuantity.create(10));
        assertThat(buyLottos.lottos().size()).isEqualTo(10);
    }
    ...
    void 로또_수동_생성_기능_테스트() {
        ...
        assertThat(manualLotto).isEqualTo(Lotto.create(lottoNumber));
    }
}
