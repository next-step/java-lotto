...
public class LottoResultStatisticsTest {
    ...
    public void getWinningPriceDetails() {
        LottoResultStatistics statistics = LottoResultStatistics.newWinnerInventory(new int[] {0, 3, 5, 6, 3, 4, 6});
        assertThat(statistics.getWinningPriceDetails()).containsKeys(RankPrice.FIRST_PLACE);
    }

    @Test
    @DisplayName("로또 총 수익률")
    public void getFinalProfit() {
        LottoResultStatistics statistics = LottoResultStatistics.newWinnerInventory(new int[] {0, 0, 0, 3, 0, 0});
