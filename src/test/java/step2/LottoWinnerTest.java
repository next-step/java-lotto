...
public class LottoWinnerTest {
    ...
    void getTotalPriceTest(String winnerNumber, int expectedPrice) {
        LottoWinner lottoWinner = new LottoWinner(List.of(new Lotto(List.of(18,1,24,25,20,21))));
        Map<Integer, Long> winnerScore = lottoWinner.getWinnerScore(winnerNumber);
    ...
    void getWinnerScoreTest(String winnerNumbers, int expectedMatchCount) {
        LottoWinner lottoWinner = new LottoWinner(List.of(new Lotto(List.of(1,2,3,15,16,17))));
        Map<Integer, Long> winnerScore = lottoWinner.getWinnerScore(winnerNumbers);
    ...
    void getNoWinnerScoreTest(String winnerNumbers) {
        LottoWinner lottoWinner = new LottoWinner(List.of(new Lotto(List.of(1,2,3,15,16,17))));
        assertThat(lottoWinner.getWinnerScore(winnerNumbers)).isEmpty();
    }
