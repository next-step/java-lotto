...
class RankTest {
    ...
    void valueWithBonusNumber(int matchCount, String rankName) {
        assertThat(RankFactory.valueWithBonusNumberFrom(matchCount)).isEqualTo(Rank.valueOf(rankName));
    }
    ...
    void valueWithoutBonusNumber(int matchCount, String rankName) {
        assertThat(RankFactory.valueFrom(matchCount)).isEqualTo(Rank.valueOf(rankName));
    }
}
