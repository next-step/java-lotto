...
class LottoTest {
    ...
    public void getMatchCount() {
        Lotto numbers = new Lotto(Lists.newArrayList(
                new LottoNumber(1), new LottoNumber(2),
                new LottoNumber(3), new LottoNumber(4),
                new LottoNumber(5), new LottoNumber(6)));


        Lotto winningNumbers = new Lotto(Lists.newArrayList(
                new LottoNumber(1), new LottoNumber(2),
                new LottoNumber(30), new LottoNumber(44),
                new LottoNumber(5), new LottoNumber(6)
        ));
    ...
    public void prizeTest() {
        Lotto lotto = new Lotto(Lists.newArrayList(
                new LottoNumber(1), new LottoNumber(2),
                new LottoNumber(30), new LottoNumber(44),
                new LottoNumber(5), new LottoNumber(6)
        ));
