...
import step2.domain.RandomNumbersGenerator;
...
class RandomNumbersGeneratorTest {
    ...
    public void 랜덤_숫자_생성_배열크기검증() throws Exception {
        ...
        assertThat(randomNumbersGenerator.createNumberList().size()).isEqualTo(defaultNumbersLength);
    }
    @DisplayName("랜덤 숫자 배열의 범위는 1부터 45까지이다.")
    @Test
    public void 랜덤_숫자_생성_배열범위검증() throws Exception {
        List<Integer> numberList = randomNumbersGenerator.createNumberList(45);
    ...
    public void 랜덤_숫자_생성_배열_출력() throws Exception {
        for (int i = 0; i < 5; i++) {
            System.out.println(randomNumbersGenerator.createNumberList(6));
        }
    }
