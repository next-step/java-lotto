...
public class PrizeTest {
    ...
    private static Stream<Arguments> lottoWithPrize() {
        return Stream.of(
            ...
            Arguments.arguments(new Lotto(new LottoNumbers(Arrays.asList(1, 2, 3, 43, 44, 45))), Prize.FOURTH),
            Arguments.arguments(new Lotto(new LottoNumbers(Arrays.asList(40, 41, 42, 43, 44, 45))), Prize.SEVENTH)
        );
    }
