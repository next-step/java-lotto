...
public class CalculatorTest {
    ...
    void 등수_1등() {
        ...
        double result = calculator.calculate(lottos, new WinningNumbers(integerList, 1));
    ...
    void 등수_2등() {
        ...
        double result = calculator.calculate(lottos, new WinningNumbers(integerList, 23));
    ...
    void 등수_3등() {
        List<Integer> integerList = Arrays.asList(3, 5, 7, 11, 45, 24);
        double result = calculator.calculate(lottos, new WinningNumbers(integerList, 25));
