...
class CalculatorApplicationTest {
    ...
    void getFirstString() {
        String[] args = {"1,2:3"};
        String first = CalculatorApplication.findFirstString(args);
    ...
    void isNumberTest() {
        ...
        final String first = CalculatorApplication.findFirstString(args);
        CalculatorApplication.isNumber(first);
    }
