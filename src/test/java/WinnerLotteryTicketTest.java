...
public class WinnerLotteryTicketTest {
    ...
    private LotteryTicket secondPrizeLotteryTicket;
    private LotteryTicket secondPrizeWithBonusLotteryTicket;
    ...
    public void 보너스번호일치여부_일치() {
        assertThat(matchedWinnerLotteryTicket.hasBonusTicketNumber(noPrizeLotteryTicket)).isTrue();
    }
