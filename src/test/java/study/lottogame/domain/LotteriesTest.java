...
public class LotteriesTest {
  ...
  public void calculateGameResult() {
    Lottery lottery1 = LotteryFactory.create(new String[]{"1", "2", "3", "4", "5", "6"});
    Lottery lottery2 = LotteryFactory.create((new String[]{"4", "5", "6", "7", "8", "9"}));
    Lottery lottery3 = LotteryFactory.create((new String[]{"1", "11", "12", "13", "14", "15"}));
