...
public class OperatorText {
    ...
    public void tokensTotalSumTest(String inputText, int sum) throws Exception {
        //given
    ...
    public void isNullOperatorTest() throws Exception {
        //given
    ...
    public void isEmptyOperatorTest() throws Exception {
        //given
        String inputText = "";
        Tokens tokens = new Tokens(inputText);
