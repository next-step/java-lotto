...
public class StringAddCalculatorTest {
    ...
    void splitAndSumOneNumber() throws Exception {
    ...
    @Test
    @DisplayName("기본 구분자인 쉼표 구분자로 구분하여 더해준다.")
    public void splitAndSumDefaultDelimiterComma() throws Exception {
    ...
    @Test
    @DisplayName("기본 구분자인 쉼표와 콜론으로 구분하여 더해준다.")
    public void splitAndSumDefaultDelimiterCommaAndColon() throws Exception {
