...
public class StringAddCalculatorTest {
    ...
    private static final StringAddCalculator addCalculator = new StringAddCalculator();

    @ParameterizedTest
    @DisplayName("입력값 빈 문자열 또는 null인 경우 0을반환")
    @ValueSource(strings = {"", "null"})
    public void 입력값_빈문자열_null인_경우(String value) {
        assertEquals(addCalculator.splitAndSum(value), 0);
    }
    ...
    public void 입력받은_값이_하나일때(int value) {
        assertEquals(addCalculator.splitAndSum("5"), value);
    }
    ...
    public void 문자열_덧셈(String value) {
        assertEquals(addCalculator.splitAndSum(value), 12);
    }
