...
public class LottoTicketTest {
    ...
    class MatchNumberTestCase {
        ...
        void 당첨_3개() {
            ...
            LottoTicket winLottoTicket = new LottoTicket(List.of(1, 2, 3, 43, 44, 45));
        ...
        void 당첨_4개() {
            // Given
            LottoTicket lottoTicket = new LottoTicket(List.of(1, 2, 3, 4, 5, 6));
            LottoTicket winLottoTicket = new LottoTicket(List.of(1, 2, 3, 4, 44, 45));
            LottoNumber bonusNumber = new LottoNumber(23);
        ...
        void 불일치() {
            // Given
            LottoTicket lottoTicket = new LottoTicket(List.of(1, 2, 3, 4, 5, 6));
            LottoTicket winLottoTicket = new LottoTicket(List.of(1, 2, 42, 43, 44, 45));
            LottoNumber bonusNumber = new LottoNumber(23);
        ...
        void 당첨_5개() {
            // Given
            LottoTicket lottoTicket = new LottoTicket(List.of(1, 2, 3, 4, 5, 6));
            LottoTicket winLottoTicket = new LottoTicket(List.of(1, 2, 3, 4, 5, 45));
            LottoNumber bonusNumber = new LottoNumber(23);
        ...
        void 당첨_5개_보너스() {
            // Given
            LottoTicket lottoTicket = new LottoTicket(List.of(1, 2, 3, 4, 5, 23));
            LottoTicket winLottoTicket = new LottoTicket(List.of(1, 2, 3, 4, 5, 45));
            LottoNumber bonusNumber = new LottoNumber(23);
