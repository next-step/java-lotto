...
public class LottoPrizePackagerTest {
    ...
    void testFirstPrize() {
        ...
        Rank first = prizeInfo.checkRank(testPick, new LottoBalls(1, 2, 3, 4, 5, 6));
    ...
    void testThirdPrize() {
        PrizeInfo prizeInfo = prizePackager.pack();
        Rank third = prizeInfo.checkRank(testPick, new LottoBalls(1, 2, 3, 4, 5, 7));
    ...
    void testFourthPrize() {
        PrizeInfo prizeInfo = prizePackager.pack();
        Rank fourth = prizeInfo.checkRank(testPick, new LottoBalls(1, 2, 3, 4, 7, 8));
    ...
    void testFifthPrize() {
        PrizeInfo prizeInfo = prizePackager.pack();
        Rank fifth = prizeInfo.checkRank(testPick, new LottoBalls(1, 2, 3, 7, 8, 9));
    ...
    void testLosePrize() {
        PrizeInfo prizeInfo = prizePackager.pack();
        Rank lose = prizeInfo.checkRank(testPick, new LottoBalls(1, 2, 7, 8, 9, 10));
