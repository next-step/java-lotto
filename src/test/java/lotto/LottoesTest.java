...
public class LottoesTest {
    ...
    public void 가진_금액_보다_구입_개수가_많은_경우() {
        ...
        Lotto test1 = new Lotto(new ManualDrawing(CommonUtils.arrayToset(new int[]{1,2,3,4,5,6})));
        Lotto test2 = new Lotto(new ManualDrawing(CommonUtils.arrayToset(new int[]{1,2,3,4,5,6})));
    ...
    public void 추첨_결과_테스트() {
        Lotto winnerNumbers = new Lotto(new ManualDrawing(CommonUtils.arrayToset(new int[]{1,2,3,4,5,6})));

        Lotto testHit3 = new Lotto(new ManualDrawing(CommonUtils.arrayToset(new int[]{1,2,3,45,35,36})));
        Lotto testHit32 = new Lotto(new ManualDrawing(CommonUtils.arrayToset(new int[]{1,2,3,45,35,36})));
        Lotto testHit4 = new Lotto(new ManualDrawing(CommonUtils.arrayToset(new int[]{1,2,3,4,35,36})));
        Lotto testHit5 = new Lotto(new ManualDrawing(CommonUtils.arrayToset(new int[]{1,2,3,4,5,36})));
        Lotto testHit6 = new Lotto(new ManualDrawing(CommonUtils.arrayToset(new int[]{1,2,3,4,5,6})));
    ...
    public void 수익률_테스트() {
        ...
        Lotto testHit3 = new Lotto(new ManualDrawing(CommonUtils.arrayToset(new int[]{1,2,3,45,35,36})));
        Lotto testHitNone = new Lotto(new ManualDrawing(CommonUtils.arrayToset(new int[]{21,22,23,24,35,36})));
