...
public class LottoesTest {
    ...
    public void 가진_금액_보다_구입_개수가_많은_경우() {
        ...
        CandidateLotto test1 = new CandidateLotto(new ManualStrategy(CommonUtils.arrayTosotedSet(new int[]{1,2,3,4,5,6})));
        CandidateLotto test2 = new CandidateLotto(new ManualStrategy(CommonUtils.arrayTosotedSet(new int[]{1,2,3,4,5,6})));
