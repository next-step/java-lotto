...
public class LottoesTest {
    ...
    public void 수동_정상_구입() {
        CandidateLotto test = new CandidateLotto(new ManualStrategy(baseNumbers));
    ...
    public void 자동_정상_구입() {
        Lottoes lottoes = new Lottoes(5 * Lotto.PRICE, Optional.empty());
    ...
    public void 수동_자동_정상_구입() {
        ...
        Lottoes lottoes = new Lottoes(5 * Lotto.PRICE, Optional.of(testCase));
