...
class MatchResult2Test {
    ...
    void initMatchResult() {
        ...
        assertThat(MatchResult2.of(payment, matchResult)).isInstanceOf(MatchResult2.class);
    }
    ...
    void initException(Money payment, Map<LottoPrizeTemp, Long> matchResult) {
        assertThatThrownBy(() -> MatchResult2.of(payment, matchResult)).isInstanceOf(IllegalArgumentException.class);
    }
