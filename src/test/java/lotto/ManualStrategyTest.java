...
public class ManualStrategyTest {
    ...
    public void 지난_로또_결과_입력_실패(String input) {
        assertThatIllegalArgumentException().isThrownBy(() -> new WinningLotto(new LottoNumber(7), new ManualStrategy(input)));
    ...
    public void 지난_로또_결과_입력_성공(String input) {
        assertThat(new WinningLotto(new LottoNumber(7), new ManualStrategy(input))).isNotNull();
    }
}
