...
public class FourthRuleTest {
    ...
    public void matchSuccessTest() {
        ...
        WinningNumber winningNumber = WinningNumber.of(List.of(10,20,3,4,5,6));
    ...
    public void matchFailTest() {
        Lotto lotto = Lotto.of(List.of(1,2,3,4,5,6));
        WinningNumber winningNumberMatch3 = WinningNumber.of(List.of(10,20,30,4,5,6));
        WinningNumber winningNumberMatch5 = WinningNumber.of(List.of(10,2,3,4,5,6));
