...
public class LottoRevenueTest {
    ...
    @Test
    void 총수익() {
        assertThat(Revenue.revenueTotal(result)).isEqualTo(2_031_555_000);
    }

    @Test
    void 수익률() {
        int money = 10000;
        assertThat(Revenue.calculateRevenue(money, Revenue.revenueTotal(result))).isEqualTo(203_155.5);
    }
}
