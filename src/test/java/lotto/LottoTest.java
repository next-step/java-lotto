...
public class LottoTest {
    ...
    public static final Lotto TEST_LOTTO = new Lotto(Lists.newArrayList(ONE, TWO, THREE, FOUR, FIVE, SIX));
    ...
    void sizeTest() {
        Assertions.assertThatThrownBy(() -> new Lotto(Lists.newArrayList(ONE, TWO, THREE)))
    ...
    void resultMatchTest() {
        Lotto winLottoNums = new Lotto(Lists.newArrayList(ONE, TWO, THREE, FOUR, FIVE, SIX));
