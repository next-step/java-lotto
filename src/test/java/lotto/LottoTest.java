...
public class LottoTest {
    ...
    void 일치하는_개수_확인() {
        ...
        assertThat(lotto.calculateMatchCount(new Lotto(Arrays.asList(1, 5, 13, 22, 43, 37)), new LottoNumber(15))).isEqualTo(3);
        assertThat(lotto.getIsBonusMatch()).isEqualTo(false);

        Lotto lotto2 = new Lotto(Arrays.asList(7, 2, 4, 5, 22, 37));
        assertThat(lotto2.calculateMatchCount(new Lotto(Arrays.asList(1, 5, 13, 22, 43, 37)), new LottoNumber(7))).isEqualTo(3);
