...
public class LottoTicketTest {
    ...
    void confirm_six_number_match() {
        LottoRank lottoRank = LottoRank.valueOf(LOTTO_TICKET.countMatchingNumber(WinningLottoNumbersTest.WINNING_LOTTO_NUMBERS), false);
    ...
    void confirm_five_number_and_bonus_number_match() {
        ...
        LottoRank lottoRank = LottoRank.valueOf(LOTTO_TICKET.countMatchingNumber(new WinningLottoNumbers(winningLottoNumbers, LottoNumberTest.THIRTY)), true);
    ...
    void confirm_five_number_match() {
        List<LottoNumber> winningLottoNumbers = Arrays.asList(LottoNumberTest.ONE, LottoNumberTest.TWO, LottoNumberTest.THREE, LottoNumberTest.FOUR, LottoNumberTest.FIVE, new LottoNumber(7));
        LottoRank lottoRank = LottoRank.valueOf(LOTTO_TICKET.countMatchingNumber(new WinningLottoNumbers(winningLottoNumbers, LottoNumberTest.THIRTY)), false);
