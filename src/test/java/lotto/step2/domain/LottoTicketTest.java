...
public class LottoTicketTest {
    ...
    void confirm_six_number_match() {
        LottoRank lottoRank = LottoRank.valueOf(LOTTO_TICKET.countMatchingNumber(WinningLottoNumbersTest.WINNING_LOTTO_NUMBERS));
    ...
    void confirm_five_number_match() {
        ...
        LottoRank lottoRank = LottoRank.valueOf(LOTTO_TICKET.countMatchingNumber(new WinningLottoNumbers(winningLottoNumbers, LottoNumberTest.THIRTY)));
