...
class LottoResultTest {
    ...
    void calculateStatistics() {
        int price = 5000;
        LottoTicket ticket = new LottoTicket(new HashSet<>(Arrays.asList(new LottoNumber(1), new LottoNumber(2), new LottoNumber(3), new LottoNumber(11), new LottoNumber(22), new LottoNumber(33))));
    ...
    void calculateStatistics3() {
        int price = 5000;
        LottoTicket ticket = new LottoTicket(new HashSet<>(Arrays.asList(new LottoNumber(1), new LottoNumber(2), new LottoNumber(3), new LottoNumber(4), new LottoNumber(15), new LottoNumber(33))));
        lottoResult.checkLottoTicket(ticket);
    ...
    void calculateStatistics2() {
        int price = 5000;
        LottoTicket ticket = new LottoTicket(new HashSet<>(Arrays.asList(new LottoNumber(1), new LottoNumber(2), new LottoNumber(3), new LottoNumber(4), new LottoNumber(5), new LottoNumber(33))));
        lottoResult.checkLottoTicket(ticket);
    ...
    void calculateStatistics4() {
        int price = 5000;
        LottoTicket ticket = new LottoTicket(new HashSet<>(Arrays.asList(new LottoNumber(1), new LottoNumber(2), new LottoNumber(3), new LottoNumber(4), new LottoNumber(5), new LottoNumber(6))));
        lottoResult.checkLottoTicket(ticket);
    ...
    void calculateStatistics5() {
        int price = 5000;
        LottoTicket ticket1 = new LottoTicket(new HashSet<>(Arrays.asList(new LottoNumber(1), new LottoNumber(2), new LottoNumber(3), new LottoNumber(14), new LottoNumber(15), new LottoNumber(16))));
        LottoTicket ticket2 = new LottoTicket(new HashSet<>(Arrays.asList(new LottoNumber(1), new LottoNumber(2), new LottoNumber(3), new LottoNumber(4), new LottoNumber(11), new LottoNumber(23))));
    ...
    void calculateStatistics7() {
        int price = 5000;
        LottoTicket ticket1 = new LottoTicket(new HashSet<>(Arrays.asList(new LottoNumber(1), new LottoNumber(2), new LottoNumber(3), new LottoNumber(14), new LottoNumber(35), new LottoNumber(26))));
        LottoTicket ticket2 = new LottoTicket(new HashSet<>(Arrays.asList(new LottoNumber(1), new LottoNumber(2), new LottoNumber(3), new LottoNumber(24), new LottoNumber(35), new LottoNumber(26))));
        lottoResult.checkLottoTicket(ticket1);
        lottoResult.checkLottoTicket(ticket2);
    ...
    void calculateStatistics8() {
        int price = 5000;
        LottoTicket ticket1 = new LottoTicket(new HashSet<>(Arrays.asList(new LottoNumber(1), new LottoNumber(2), new LottoNumber(3), new LottoNumber(4), new LottoNumber(5), new LottoNumber(6))));
        LottoTicket ticket2 = new LottoTicket(new HashSet<>(Arrays.asList(new LottoNumber(1), new LottoNumber(2), new LottoNumber(3), new LottoNumber(4), new LottoNumber(5), new LottoNumber(6))));
        lottoResult.checkLottoTicket(ticket1);
        lottoResult.checkLottoTicket(ticket2);
        assertThat(lottoResult.calculateStatistics(price)).isEqualTo(400000.00);
    }
