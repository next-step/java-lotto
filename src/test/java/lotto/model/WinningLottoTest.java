...
class WinningLottoTest {
    ...
    void createWrongWinningLotto() {
        assertThatIllegalArgumentException().isThrownBy(() -> new WinningLotto(new Lotto(1, 2, 3, 4, 5, 6), LottoNumber.of(1)));
    }
    ...
    void calculateMissPrize() {
        Lotto lotto = new Lotto(1, 2, 3, 4, 5, 6);
        WinningLotto winningLotto = new WinningLotto(new Lotto(38, 39, 40, 41, 42, 43), LottoNumber.of(45));
