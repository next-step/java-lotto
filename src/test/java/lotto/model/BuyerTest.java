    ...
    void 구매자의_로또목록을_출력한다() {
        Buyer buyer = Buyer.of(
                ...
                new BuyerFixtureNumberCreator(Arrays.asList(
                        Arrays.asList(of(8), of(21), of(23), of(41), of(42), of(43)),//111111-1
                        Arrays.asList(of(1), of(8), of(11), of(31), of(41), of(42))//111-5
                ))
        );
        ...
        List<List<LottoNumber>> expected = Arrays.asList(
                Arrays.asList(of(8), of(21), of(23), of(41), of(42), of(43)),//111111-1
                Arrays.asList(of(1), of(8), of(11), of(31), of(41), of(42))//111-5
        );
