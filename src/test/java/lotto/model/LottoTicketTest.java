...
class LottoTicketTest {
    ...
    void test1() {
        var lottoTicket = new LottoTicket(new String[]{"1", "2", "3", "4", "5", "6"});
    ...
    void test2() {
        assertThatThrownBy(() -> {
            var lottoTicket = new LottoTicket(new String[]{"1", "2", "3", "4", "5", "6", "7"});
        })
    ...
    void test3() {
        assertThatThrownBy(() -> {
            var lottoTicket = new LottoTicket(new String[]{"0", "1", "2", "3", "4", "5"});
        })
                .isInstanceOf(IllegalArgumentException.class)
