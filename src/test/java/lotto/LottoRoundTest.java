...
class LottoRoundTest {
    ...
    public void lottoRank() throws Exception {
        ...
        Assertions.assertThat(lottoRound.checkLottoRank(new LottoNumbers("1,2,3,4,7,8")))
    ...
    public void lottoRanks() throws Exception {
        ...
        LottoResult lottoResult = lottoRound.checkLottoRank(List.of(first, first, second, second, second, third, fourth, etc, etc));
