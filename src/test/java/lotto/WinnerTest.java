...
public class WinnerTest {
    Set<LottoNum> winnerNums = LottoTicket.ofString("1, 2, 3, 4, 5, 6").getLottoNums();
    ...
    void matchNumbersFourTest() {
        LottoTicket lottoTicket = LottoTicket.ofString("1, 2, 3, 4, 11, 12");
    ...
    void matchNumbersFiveTest() {
        LottoTicket lottoTicket = LottoTicket.ofString("1, 2, 3, 4, 5, 12");
    ...
    void matchNumbersSixTest() {
        LottoTicket lottoTicket = LottoTicket.ofString("1, 2, 3, 4, 5, 6");
