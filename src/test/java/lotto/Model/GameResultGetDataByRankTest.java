...
*/
    ...
    @Test
    @DisplayName("1등 일치한 숫자 개수 확인")
    public void gameResult_get_matched_rank_1() {
        int expected = 6;
        int actual = gameResult.countOfMatchedNumberByRank(1);

        assertThat(actual).isEqualTo(expected);
    }

    @Test
    @DisplayName("2등 일치한 숫자 개수 확인")
    public void gameResult_get_matched_rank_2() {
        int expected = 5;
        int actual = gameResult.countOfMatchedNumberByRank(2);

        assertThat(actual).isEqualTo(expected);
    }

    @Test
    @DisplayName("3등 일치한 숫자 개수 확인")
    public void gameResult_get_matched_rank_3() {
        int expected = 5;
        int actual = gameResult.countOfMatchedNumberByRank(3);

        assertThat(actual).isEqualTo(expected);
    }

    @Test
    @DisplayName("4등 일치한 숫자 개수 확인")
    public void gameResult_get_matched_rank_4() {
        int expected = 4;
        int actual = gameResult.countOfMatchedNumberByRank(4);

        assertThat(actual).isEqualTo(expected);
    }

    @Test
    @DisplayName("5등 일치한 숫자 개수 확인")
    public void gameResult_get_matched_rank_5() {
        int expected = 3;
        int actual = gameResult.countOfMatchedNumberByRank(5);
