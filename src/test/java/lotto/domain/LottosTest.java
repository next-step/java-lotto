...
class LottosTest {
    ...
    @Test
    void 수익률() {
        assertThat(lottos.rateOfReturn(new WinningNumbersDTO("1,2,3,4,5,6", "33")))
    ...
    @Test
    void FIRST_당첨_개수() {
        assertThat(lottos.winningCorrectCount(new WinningNumbersDTO("1,2,3,4,5,6", "33"), Winning.FIRST))
                .isEqualTo(1);
    }
    @DisplayName("2등 당첨 갯수")
    @Test
    void SECOND_당첨_개수() {
        assertThat(lottos.winningCorrectCount(new WinningNumbersDTO("1,2,3,4,5,6", "33"), Winning.SECOND))
                .isEqualTo(1);
    }
    @DisplayName("3등 당첨 갯수")
    @Test
    void THIRD_당첨_개수() {
        assertThat(lottos.winningCorrectCount(new WinningNumbersDTO("1,2,3,4,5,6", "33"), Winning.THIRD))
                .isEqualTo(2);
    }
    @DisplayName("4등 당첨 갯수")
    @Test
    void FOURTH_당첨_개수() {
        assertThat(lottos.winningCorrectCount(new WinningNumbersDTO("1,2,3,4,5,6", "33"), Winning.FOURTH))
                .isEqualTo(2);
    }
    @DisplayName("5등 당첨 갯수")
    @Test
    void FIFTH_당첨_개수() {
        assertThat(lottos.winningCorrectCount(new WinningNumbersDTO("1,2,3,4,5,6", "33"), Winning.FIFTH))
                .isEqualTo(3);
    }
}