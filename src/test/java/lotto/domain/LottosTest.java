...
class LottosTest {
    ...
    void success_lotto_winning_count(List<Integer> lottoNumbers, List<Integer> winLottoNumbers, int bonusBall, LottoRank lottoRank, long winCount) {
        ...
        assertThat(lottoResult.getLottoResult()).hasSize(5)
                .contains(
                        entry(lottoRank, winCount)
                );
    }

    private static Stream<Arguments> provideWinLottoNumbersAndWinCount() {
        return Stream.of(
                Arguments.of(List.of(3, 5, 11, 1, 2, 4), List.of(3, 5, 11, 20, 21, 22), 44, LottoRank.FIFTH, 1L),
                Arguments.of(List.of(7, 11, 16, 35, 2, 4), List.of(7, 11, 16, 35, 1, 3), 44, LottoRank.FOURTH, 1L),
                Arguments.of(List.of(1, 8, 11, 31, 41, 42), List.of(1, 8, 11, 31, 41, 43), 44, LottoRank.THIRD, 1L),
                Arguments.of(List.of(1, 8, 11, 31, 41, 44), List.of(1, 8, 11, 31, 41, 43), 44, LottoRank.SECOND, 1L),
                Arguments.of(List.of(13, 14, 16, 38, 42, 45), List.of(13, 14, 16, 38, 42, 45), 44, LottoRank.FIRST, 1L)
        );
    }
