...
class LottosTest {
    ...
    void findStatisticsTest() {
        ...
        Map<Integer, Integer> statisticsMap = lottos.findStatistics(winningLotto);

        assertThat(statisticsMap)
                .hasSize(4);

        assertThat(statisticsMap.get(6))
                .isEqualTo(1);

        assertThat(statisticsMap.get(5))
                .isEqualTo(2);

        assertThat(statisticsMap.get(4))
                .isEqualTo(1);

        assertThat(statisticsMap.get(3))
                .isEqualTo(1);
    }
