...
class LottoWinningResultsTest {
    ...
    void shouldCalculateTotalWinningPrice() {
        final LottoWinningResult lottoWinningResult1 = new LottoWinningResult(LottoRank.fifth(), LottoBundle.issues(3));
        final LottoWinningResult lottoWinningResult2 = new LottoWinningResult(LottoRank.fourth(), LottoBundle.issues(1));
