...
public class RankTest {
    ...
    public void valueOf() {
        assertAll(
                ...
                () -> assertThat(Rank.valueOf(2, MISMATCH_BONUS)).isEqualTo(Rank.MISS),
                () -> assertThat(Rank.valueOf(1, MATCH_BONUS)).isEqualTo(Rank.MISS),
                () -> assertThat(Rank.valueOf(1, MISMATCH_BONUS)).isEqualTo(Rank.MISS),
                () -> assertThat(Rank.valueOf(0, MATCH_BONUS)).isEqualTo(Rank.MISS),
                () -> assertThat(Rank.valueOf(0, MISMATCH_BONUS)).isEqualTo(Rank.MISS)
        );
    }
