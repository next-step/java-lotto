...
public class LottoProfitCalculatorTest {
    ...
    void calculate() {
        ...
        float profit = LottoProfitCalculator.calculate(1, result);
    ...
    void calculate_zero() {
        ...
        float profit = LottoProfitCalculator.calculate(10000, result);
    ...
    void calculate_profit() {
        ...
        float profit = LottoProfitCalculator.calculate(77, result);
