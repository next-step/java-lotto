...
class LottoResultStatsCalculatorTest {
    ...
    void computeResultStats_winingNothing() {
        ...
        assertThat(resultStats.getFifthRankCount()).isZero();
    ...
    void computeResultStats_winingFifth() {
        ...
        assertThat(resultStats.getThirdRankCount()).isZero();
        assertThat(resultStats.getFourthRankCount()).isZero();
        assertThat(resultStats.getFifthRankCount()).isEqualTo(1);
        assertThat(resultStats.getTotalWiningMoney())
            .isEqualTo(resultStats.getFifthRankPrizeMoney());
    }
    ...
    void computeResultStats_winingAll() {
        purchased = Arrays.asList(
            ...
            // Third
            new LottoTicket(Money.ONE, LottoNumbers.of(1, 2, 3, 4, 5, 45)),
            new LottoTicket(Money.ONE, LottoNumbers.of(1, 2, 3, 4, 45, 6)),
            // Fourth
            new LottoTicket(Money.ONE, LottoNumbers.of(1, 2, 3, 4, 40, 45)),
            new LottoTicket(Money.ONE, LottoNumbers.of(1, 2, 30, 40, 5, 6)),
            new LottoTicket(Money.ONE, LottoNumbers.of(10, 20, 3, 4, 5, 6)),
            // Fifth
            new LottoTicket(Money.ONE, LottoNumbers.of(1, 2, 3, 35, 40, 45)),
            // Nothing
        ...
        final Money expectedTotalWiningMoney = resultStats
            ...
            .plus(resultStats.getFifthRankPrizeMoney().multiply(resultStats.getFifthRankCount()));
