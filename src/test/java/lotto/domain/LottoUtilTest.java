...
class LottoUtilTest {
	...
	void 로또공들의_데이터가_주어질때_각_경우별로_1개씩_당첨되었을때_당첨_통계값이_일치해야한다() {
		Map<Integer, Integer> winStatistics = LottoUtil.getLottoStatistics(lotteries, new int[] {1, 2, 3, 4, 5, 6});
	...
	void 당첨_통계값이_주어질_때_통계값_일치해야한다() {
		...
		assertThat(LottoUtil.getRateOfReturn(14, winStatistics)).isEqualTo(0.35f);
	}
}
