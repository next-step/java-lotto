...
class LottoGameTest {
    ...
    void initialize() {
        LottoGame lottoGame = new LottoGame(15000, Collections.emptyList());
    ...
    void manualLotto() {
        ...
        numberValues.add("1,2,3,4,5,6");
        numberValues.add("1,2,3,4,7,8");
        LottoGame lottoGame = new LottoGame(15000, numberValues);
    ...
    void allManualLotto() {
        ...
        numberValues.add("1,2,3,4,5,6");
        numberValues.add("1,2,3,4,7,8");
        LottoGame lottoGame = new LottoGame(2000, numberValues);
    ...
    void invalidManualLotto() {
        ...
        assertThatThrownBy(() -> new LottoGame(1000, numberValues))
