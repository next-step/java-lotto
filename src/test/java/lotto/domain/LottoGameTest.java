...
public class LottoGameTest {
    ...
    @BeforeEach
    void setUp() {
        lottoGame = new LottoGame((count) -> List.of(new Lotto(numbers(1, 2, 3, 4, 5, 6))));
    }

    @Test
    void 당첨_결과() {
        WinningResult result = lottoGame.match(List.of(new Lotto(numbers(1, 2, 3, 4, 5, 6)), new Lotto(numbers(11, 12, 13, 14, 15, 16)), new Lotto(numbers(1, 2, 3, 4, 5, 7))), new InputNumber("1, 2, 3, 4, 5, 6", "7"));
    ...
    @Test
    void 로또_발급() {
        assertThat(lottoGame.create("1000")).isEqualTo(List.of(new Lotto(numbers(1, 2, 3, 4, 5, 6))));
    }
}
