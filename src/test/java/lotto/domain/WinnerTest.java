...
class WinnerTest {
    ...
    void 두_게임의_일치하는_로또번호_갯수를_확인한다(LottoNumbers game1, LottoNumbers game2, int expected) {
    ...
    private static Stream<Arguments> comparingIdenticalLottoNumber() {
        return Stream.of(
                Arguments.arguments(new LottoNumbers(List.of(1, 2, 3, 4, 5, 6)), new LottoNumbers(List.of(7, 8, 9, 10, 11, 12)), 0),
                Arguments.arguments(new LottoNumbers(List.of(1, 2, 3, 4, 5, 6)), new LottoNumbers(List.of(1, 10, 20, 30, 40, 45)), 1),
                Arguments.arguments(new LottoNumbers(List.of(1, 2, 3, 4, 5, 6)), new LottoNumbers(List.of(4, 5, 6, 7, 8, 9)), 3),
                Arguments.arguments(new LottoNumbers(List.of(1, 2, 3, 4, 5, 6)), new LottoNumbers(List.of(1, 2, 3, 4, 5, 6)), 6)
        );
    }
