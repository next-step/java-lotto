...
public class LottoTest {
    ...
    public void createLottoNumberTest() {
        List<LottoNumber> lottoNumbers = LottoNumberPool.get(1,2,3,4,5,6);
    ...
    public void validateSixNumberTest() {
        assertThatThrownBy(() -> {
           Lotto.of(LottoNumberPool.get(1,2));
    ...
    public void validateDuplicateNumberTest() {
        assertThatThrownBy(() -> {
            Lotto.of(LottoNumberPool.get(1,2,3,4,4,6));
        }).isInstanceOf(IllegalArgumentException.class);
    }
    ...
    public void getContainCountTest() {
        ...
        int counts = lotto.getContainCount(LottoNumberPool.get(1,2,3));
