...
public class ProfitCalculatorTest {
    ...
    void calculateProfit() {
        ...
        List<WinningType> plusWinningTypes = Arrays.asList(WinningType.FIFTH, WinningType.FORTH, WinningType.MISS);
        assertThat(profitCalculator.calculate(3000, plusWinningTypes) >= 1).isTrue();

        //손해일 때 profit은 1보다 작다.
        List<WinningType> MinusWinningTypes = Arrays.asList(WinningType.FIFTH, WinningType.MISS, WinningType.MISS);
