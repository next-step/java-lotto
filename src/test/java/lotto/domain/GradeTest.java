...
class GradeTest {
    ...
    public void Grade_Should_Conversion_From_CorrectingCount() {
        assertThat(Grade.fromMatchResult(new WinningNumberResult(6, false))).isEqualTo(FIRST_GRADE);
    }
    ...
    public void Grade_Should_Conversion_From_CorrectingCount_To_Un_Lucky_Grade(int input) {
        assertThat(Grade.fromMatchResult(new WinningNumberResult(input, false))).isEqualTo(UN_LUCKY_GRADE);
    }
    ...
    public void Grade_Should_Conversion_From_CorrectingCount_To_Bonus_Grade() {
        assertThat(Grade.fromMatchResult(new WinningNumberResult(5, true))).isEqualTo(BONUS_GRADE);
    }
}
