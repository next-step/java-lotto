...
class LottoBonusTest {
    ...
    void bonus_number_validation() {
        assertThatThrownBy(() -> LottoBonus.of(LottoNumbers.of("1,2,3,4,5,6"), LottoNumber.of("1")))
    ...
    void lotto_numbers_to_result() {
        LottoBonus bonus = LottoBonus.of(LottoNumbers.of("1,2,3,4,5,6"), LottoNumber.of("7"));
