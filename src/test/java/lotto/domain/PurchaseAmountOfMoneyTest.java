...
class PurchaseAmountOfMoneyTest {
    ...
    void testInstanceCreationFailCase(String amountOfMoney) {
    ...
    void testNumberOfLottoToPurchase(String amountOfMoney, int expected) {
    ...
    void testRateOfReturn(String amountOfMoney, int winningAmountOfMoney, double expected) {
        PurchaseAmountOfMoney purchaseAmountOfMoney = PurchaseAmountOfMoney.valueOf(amountOfMoney);
