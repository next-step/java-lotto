...
public class LottoTicketTest {
    ...
    static Stream<Arguments> generateTicketCountException() {
        return Stream.of(
            ...
            Arguments.of(new ArrayList<>(Arrays.asList(1, 2, 3, 4, 44, 45, 5)))
        );
    }

    static Stream<Arguments> generateTicketNumberException() {
        return Stream.of(
            Arguments.of(new ArrayList<>(Arrays.asList(1, 2, 3, 4, 5, 46))),
            Arguments.of(new ArrayList<>(Arrays.asList(0, 2, 3, 4, 44, 45)))
        );
    }
    ...
    void create() {
        List<Integer> args = new ArrayList<>(Arrays.asList(1, 2, 3, 4, 5, 6));
    ...
    void ticketCountException(List<Integer> ticket) {
    ...
    void ticketNumberException(List<Integer> ticket) {
