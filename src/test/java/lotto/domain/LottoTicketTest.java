...
public class LottoTicketTest {
    ...
    void checkWinningType() {
        ...
        winningType = userFirstLottoTicket.getWinningType(winningLottoTicket, LottoNumber.of(10));
        ...
        winningType = userForthLottoTicket.getWinningType(winningLottoTicket, LottoNumber.of(10));
        ...
        winningType = userSeventhLottoNumbers.getWinningType(winningLottoTicket, LottoNumber.of(10));
