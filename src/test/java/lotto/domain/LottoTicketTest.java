...
public class LottoTicketTest {
	...
	public void test_로또_번호_1등() {
		...
		LottoNumber winningLottoTicket = WinningLottoTicket.newInstance(Arrays.asList(1, 2, 3, 4, 5, 6), 7);
	...
	public void test_로또_번호_2등() {
		LottoNumber lottoTicket = LottoTicket.newInstanceByAutomation(() -> Arrays.asList(1, 2, 3, 4, 5, 6));
		LottoNumber winningLottoTicket = WinningLottoTicket.newInstance(Arrays.asList(1, 2, 3, 4, 5, 7), 6);
		LottoWinnerType winnerType = winningLottoTicket.matchNumber(lottoTicket);
	...
	public void test_로또_번호_3등() {
		LottoNumber lottoTicket = LottoTicket.newInstanceByAutomation(() -> Arrays.asList(1, 2, 3, 4, 5, 6));
		LottoNumber winningLottoTicket = WinningLottoTicket.newInstance(Arrays.asList(1, 2, 3, 4, 5, 7), 9);
		LottoWinnerType winnerType = winningLottoTicket.matchNumber(lottoTicket);
	...
	public void test_로또_번호_4등() {
		LottoNumber lottoTicket = LottoTicket.newInstanceByAutomation(() -> Arrays.asList(1, 2, 3, 4, 5, 6));
		LottoNumber winningLottoTicket = WinningLottoTicket.newInstance(Arrays.asList(1, 2, 3, 4, 8, 7), 6);
		LottoWinnerType winnerType = winningLottoTicket.matchNumber(lottoTicket);
	...
	public void test_로또_번호_5등() {
		LottoNumber lottoTicket = LottoTicket.newInstanceByAutomation(() -> Arrays.asList(1, 2, 3, 4, 5, 6));
		LottoNumber winningLottoTicket = WinningLottoTicket.newInstance(Arrays.asList(1, 2, 3, 9, 8, 7), 6);
		LottoWinnerType winnerType = winningLottoTicket.matchNumber(lottoTicket);
	...
	public void test_로또_번호_꽝_2개() {
		LottoNumber lottoTicket = LottoTicket.newInstanceByAutomation(() -> Arrays.asList(1, 2, 3, 4, 5, 6));
		LottoNumber winningLottoTicket = WinningLottoTicket.newInstance(Arrays.asList(1, 2, 10, 9, 8, 7), 1);
		LottoWinnerType winnerType = winningLottoTicket.matchNumber(lottoTicket);
	...
	public void test_로또_번호_꽝_1개() {
		LottoNumber lottoTicket = LottoTicket.newInstanceByAutomation(() -> Arrays.asList(1, 2, 3, 4, 5, 6));
		LottoNumber winningLottoTicket = WinningLottoTicket.newInstance(Arrays.asList(1, 11, 10, 9, 8, 7), 1);
		LottoWinnerType winnerType = winningLottoTicket.matchNumber(lottoTicket);
