...
public class BonusNumberTest {
    ...
    void fromValidDuplicate_in_lottoNumber_exception(int input) {
        assertThatThrownBy(() -> BonusNumber.fromValidDuplicate(input, dumpLottoNumber())).isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void fromValidDuplicate_not_in_lottoNumber(int input) {
        assertThat(BonusNumber.fromValidDuplicate(input, dumpLottoNumber())).isInstanceOf(BonusNumber.class);
    }
    ...
    void fromValidDuplicate_min_number_valid_exception() {
        ...
        assertThatThrownBy(() -> BonusNumber.fromValidDuplicate(invalidNumber, dumpLottoNumber())).isInstanceOf(IllegalArgumentException.class);
    }
