...
public class LottoMachineTest {
    ...
    void 로또머신의_자동생성기능_이용하여_3장_생성을_시도하면_3장의_로또티켓객체를_가진_리스트가_생성된다() {
        ...
        LottoTickets lottoTickets = lottoMachine.autoCreate(autoLottoTicketCount);
        assertThat(lottoTickets.toList().size()).isEqualTo(autoLottoTicketCount);
        lottoTickets.toList().forEach(lottoTicket -> assertThat(lottoTicket).isInstanceOf(LottoTicket.class));
    }
