...
class LottoMachineTest {
	...
	void pickRandomLottoNumbers() {
		LottoTickets lottoTickets = lottoMachine.issueLottoTickets(new LottoMoney(1000), new ArrayList<>());
		List<LottoTicket> tickets = lottoTickets.getTickets();
		LottoTicket lottoTicket = tickets.get(0);
	...
	void issueLottoTickets(int money, int numberOfLottoTickets) {
		LottoTickets lottoTickets = lottoMachine.issueLottoTickets(new LottoMoney(money), new ArrayList<>());
