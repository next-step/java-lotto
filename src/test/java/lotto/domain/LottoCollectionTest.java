...
class LottoCollectionTest {
    ...
    void lottoCollectionTest() {
        ...
        assertThat(lottoList.get(8).getNumbers()).containsExactlyInAnyOrder(1, 3, 5, 14, 22, 45);
        assertThat(lottoList.get(13).getNumbers()).containsExactlyInAnyOrder(3, 8, 27, 30, 35, 43);
    }
