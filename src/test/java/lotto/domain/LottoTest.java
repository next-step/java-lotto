...
public class LottoTest {
    ...
    void matchingNumber_매칭되는_숫자_갯수_확인() {
        ...
        assertThat(lotto.getMatchingCount(new Lotto(Arrays.asList(1, 4, 6, 9, 11, 15)))).isEqualTo(new MatchingCount(5));
    }
    ...
    void matchingNumber_해당_숫자가_없으면_false() {
        Lotto lotto = new Lotto(Arrays.asList(1, 4, 6, 9, 10, 15));
        assertThat(lotto.hasLottoNumber(new LottoNumber(2))).isFalse();
    }
