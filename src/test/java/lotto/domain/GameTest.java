...
public class GameTest {
    ...
    void 지난주_로또_번호는_쉼표를_구분지어_입력한다() {
        assertThatThrownBy(() -> {
            ...
            game.play(InputView.convertStringToList("1, 2, 3, 4, 5, 6, 10"), bonusNumber);
        ...
        assertThatThrownBy(() -> {
            Game game = new Game(1000);
            game.play(InputView.convertStringToList("1, 2, 3, 4, 5, 46"), bonusNumber);
        ...
        assertThatCode(() -> {
            ...
            game.rollingLotto();
            game.play(InputView.convertStringToList("1, 2, 3, 4, 5, 6"), bonusNumber);
