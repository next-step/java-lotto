...
class PurchaseInfomationTest {
    ...
    public void PurchaseAmount_Should_Create_Purchase_Amount_In_Multiple_Of_1000() {
        PurchaseInfomation purchaseInfomation = new PurchaseInfomation(20000);
        assertThat(purchaseInfomation.getPurchaseAmount()).isEqualTo(20000);
    }
    ...
    public void PurchaseAmount_Should_Throw_Exception_If_Purchase_Amount_Is_Not_Multiple_Of_1000() {
        assertThatThrownBy(() -> new PurchaseInfomation(12345))
