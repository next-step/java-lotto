...
class WinningLottoTest {
    ...
    void winning_lotto_number_test() {
        ...
        // when
        WinningLotto winningLotto = WinningLotto.ofLottoNumbers(lottoMachine.createManualLottoNumbers(StringSplitter.splitText(numbers)), bonusBall);
    ...
    void bonus_ball_duplication_test() {
        assertThatExceptionOfType(IllegalArgumentException.class).isThrownBy(() -> {
            String numbers = "1,2,3,4,5,6";
            int bonusBall = 6;
            WinningLotto.ofLottoNumbers(lottoMachine.createManualLottoNumbers(StringSplitter.splitText(numbers)), bonusBall);
