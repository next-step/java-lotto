...
class BonusTest {
    ...
    @Test
    @DisplayName("보너스 숫자의 범위가 1보다 작거나 45보다 크면 예외가 발생한다")
    void range_exception_test() {
        Lotto winningLotto = new Lotto(Set.of(1, 2, 3, 4, 5, 6));
        assertThrows(IllegalArgumentException.class, () -> new Bonus(0, winningLotto));
        assertThrows(IllegalArgumentException.class, () -> new Bonus(46, winningLotto));
    }
