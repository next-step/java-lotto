...
public class LottoResultTest {
    ...
    void 당첨_수익률_생성() {
        assertThat(new LottoResult(List.of(5, 6), 10000).getReturnRate()).isEqualTo(200150);
    }

    @Test
    @DisplayName("로또 결과에서 당첨금액 합산한 값 반환")
    void 당첨_결과_생성() {
        assertThat(new LottoResult(List.of(5, 6), 14000).getPriceTotal()).isEqualTo(2001500000);
    }
}
