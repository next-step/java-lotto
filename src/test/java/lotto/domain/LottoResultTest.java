...
public class LottoResultTest {
    ...
    public void  당첨금_검증() {
        ...
        lottoResult.addResult(3);  // 5000
        lottoResult.addResult(3);  // 5000
        lottoResult.addResult(4);  // 50000
        lottoResult.addResult(5);  // 1500000
        ...
        assertThat(lottoResult.getTotalPrize()).isEqualTo(1500000 + 50000 + 5000 + 5000);
    }
