...
class LottoResultTest {
    ...
    void statisticsMatchCount() {
        // given
        WinningLotto winningLotto = new WinningLotto(Arrays.asList(1, 2, 3, 4, 5, 6), 30);
        ...
        assertThat(lottoResult.getPrizeCount(LottoPrize.THIRD)).isEqualTo(0);
    ...
    void getProfitRate() {
        ...
        assertThat(lottoResult.getProfitRate(money))
                .isEqualTo((float) (LottoPrize.FOURTH.getMoney() + LottoPrize.FIRST.getMoney()) / money.getMoney());
    }
}