...
class LottoResultTest {
    ...
    @BeforeEach
    void setLottoTicket() {
        lottoTickets.add(lottoMachine.generateManualLottoNumbers(StringSplitter.splitText("1,2,3,4,5,6")));
        lottoTickets.add(lottoMachine.generateManualLottoNumbers(StringSplitter.splitText("1,2,3,4,5,45")));
        lottoTickets.add(lottoMachine.generateManualLottoNumbers(StringSplitter.splitText("1,2,3,4,5,7")));
        lottoTickets.add(lottoMachine.generateManualLottoNumbers(StringSplitter.splitText("1,2,3,4,44,45")));
        lottoTickets.add(lottoMachine.generateManualLottoNumbers(StringSplitter.splitText("1,2,3,43,44,45")));
    }
