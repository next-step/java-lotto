...
public class LottoResultTest {
    ...
    public void  당첨금_검증() {
        ...
        lottoResult.addResult(LottoMchine.getPrize(3));  // 5000
        lottoResult.addResult(LottoMchine.getPrize(3));  // 5000
        lottoResult.addResult(LottoMchine.getPrize(4));  // 50000
        lottoResult.addResult(LottoMchine.getPrize(5));  // 1500000
