...
class LottoResultTest {
    ...
    static Stream<Arguments> resultSource() {
        return Stream.of(arguments(
                new Lottos(
                        Lists.list(
                                new Lotto(LottoBalls.createManualLottoBalls(40, 41, 42, 43, 44, 45)), //Prize.ZERO
                                new Lotto(LottoBalls.createManualLottoBalls(40, 41, 42, 43, 44, 45)), //Prize.ZERO
                                new Lotto(LottoBalls.createManualLottoBalls(1, 2, 3, 4, 5, 6)), //Prize.THREE
                                new Lotto(LottoBalls.createManualLottoBalls(1, 2, 3, 13, 5, 6)), //Prize.FOUR
                                new Lotto(LottoBalls.createManualLottoBalls(1, 2, 13, 14, 15, 6)), //Prize.BONUS
                                new Lotto(LottoBalls.createManualLottoBalls(1, 2, 3, 13, 14, 26)), //Prize.FIVE
                                new Lotto(LottoBalls.createManualLottoBalls(1, 2, 3, 13, 14, 15)) //Prize.SIX
                        )
                ),
                new WinningLotto(LottoBalls.createManualLottoBalls(1, 2, 3, 13, 14, 15), LottoBall.valueOf(6)))
        );
    }
