...
class LottoNumbersTest {
    ...
    void 한_게임에_로또번호는_6개다() {
        ...
        assertThatNoException().isThrownBy(() -> new LottoNumbers(set));
    }
    ...
    void 한_게임에_로또번호는_6개다(int count) {
        ...
        assertThatIllegalArgumentException().isThrownBy(() -> new LottoNumbers(set))
    ...
    void 같은_번호의_갯수를_반환한다(Set<Integer> numbers1, Set<Integer> numbers2, int expected) {
    ...
    private static Stream<Arguments> compareIdenticalNumber() {
        return Stream.of(
                Arguments.arguments(Set.of(1, 2, 3, 4, 5, 6), Set.of(1, 2, 3, 4, 5, 6), 6),
                Arguments.arguments(Set.of(1, 2, 3, 4, 5, 6), Set.of(1, 2, 3, 4, 5, 7), 5),
                Arguments.arguments(Set.of(1, 2, 3, 4, 5, 6), Set.of(1, 2, 3, 4, 7, 8), 4),
                Arguments.arguments(Set.of(1, 2, 3, 4, 5, 6), Set.of(1, 2, 3, 7, 8, 9), 3),
                Arguments.arguments(Set.of(1, 2, 3, 4, 5, 6), Set.of(1, 2, 7, 8, 9, 10), 2),
                Arguments.arguments(Set.of(1, 2, 3, 4, 5, 6), Set.of(1, 7, 8, 9, 10, 11), 1),
                Arguments.arguments(Set.of(1, 2, 3, 4, 5, 6), Set.of(7, 8, 9, 10, 11, 12), 0)
        );
    }
    ...
    void toString은_게임_내_숫자를_반환한다() {
        LottoNumbers game = new LottoNumbers(Set.of(1, 2, 3, 4, 5, 6));
