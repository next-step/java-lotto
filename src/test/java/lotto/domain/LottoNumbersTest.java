...
class LottoNumbersTest {
  ...
  void generate(String numbers) {
    ...
    assertThat(lottoNumbers).usingRecursiveComparison().isEqualTo(LottoNumbers.of(numbers));
  }
  ...
  void generator(String numbers) {
    ...
    LottoNumbers lottoNumbers = LottoNumbers.of(intNumbers);

    assertThat(lottoNumbers).usingRecursiveComparison().isEqualTo(LottoNumbers.of(intNumbers));
  }
  ...
  void match(String numbers, String winNumbers, int matchCount) {
    LottoNumbers lottoNumbers = LottoNumbers.of(new FixedNumberGenerator(numbers).generate());
    LottoNumbers winLottoNumbers = LottoNumbers.of(new FixedNumberGenerator(winNumbers).generate());
