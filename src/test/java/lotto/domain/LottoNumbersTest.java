...
class LottoNumbersTest {
    ...
    void aggregateLottoNumber() {
        ...
        assertThat(lottoNumbers.aggregateNonDuplicateLottoNumber().getLottoNumberGroupSize()).isEqualTo(6);
    }
    ...
    void manualLottoNumber() {
        ...
        assertThat(lottoNumbers.initializedManualLottoNumber(given)).isEqualTo(new LottoNumbers(result));
    }
    ...
    void throwNotSize_six_LottNumberSize(List<Integer> lottoNumber) {
        assertThatIllegalArgumentException().isThrownBy(() -> lottoNumbers.initializedManualLottoNumber(lottoNumber))
    ...
    void findMatchingLottNumber() {
        ...
        LottoNumbers winingLotto = lottoNumbers.initializedManualLottoNumber(winningNumberGroup);

        List<Integer> requestLottoNumberGroup = List.of(1, 2, 3, 11, 12, 15);
        LottoNumbers request = lottoNumbers.initializedManualLottoNumber(requestLottoNumberGroup);
