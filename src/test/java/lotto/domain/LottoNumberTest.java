...
public class LottoNumberTest {
    ...
    void bonusNumberFrom_in_lottoNumber_exception(int input) {
        assertThatThrownBy(() -> LottoNumber.bonusNumberFrom(input, dumpLottoNumber())).isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void bonusNumberFrom_not_in_lottoNumber(int input) {
        assertThatNoException().isThrownBy(()-> LottoNumber.bonusNumberFrom(input, dumpLottoNumber()));
    }
    ...
    void bonusNumberFrom_min_number_valid_exception() {
        ...
        assertThatThrownBy(() -> LottoNumber.bonusNumberFrom(invalidNumber, dumpLottoNumber())).isInstanceOf(IllegalArgumentException.class);
    }
    ...
    private LottoNumbers dumpLottoNumber() {
        return LottoNumbers.from(List.of(1, 2, 3, 4, 5, 6));
    }
}
