...
public class LottoNumberTest {
    ...
    void from_success() {
        LottoNumber lottoNumber = createLottoNumber(1,2,3,4,5,6);
    ...
    static Stream<Arguments> lottoNumbersAndContainsCount() {
        ...
        return Stream.of(
                Arguments.arguments(lottoNumber, createLottoNumber(1, 2, 3, 4, 5, 6), 6),
                Arguments.arguments(lottoNumber, createLottoNumber(1, 2, 3, 4, 5, 42), 5),
                Arguments.arguments(lottoNumber, createLottoNumber(1, 2, 3, 4, 29, 38), 4),
                Arguments.arguments(lottoNumber, createLottoNumber(1, 2, 3, 30, 31, 32), 3)
        );
    }
