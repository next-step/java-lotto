...
class LottoTicketsTest {
    ...
    void 로또_장당_당첨번호_개수_일치여부_테스트() {
        LottoTickets lottoTickets=new LottoTickets(2000,Arrays.asList(new Lotto(Arrays.asList(1,2,3,4,5,6)),new Lotto(Arrays.asList(5,6,7,8,9,10))));
        List<Integer> correctWinNumbers = lottoTickets.countCorrectWinNumber(
