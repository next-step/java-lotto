...
class LottoTicketsTest {
    ...
    void totalReturnRate() {
        ...
        LottoNumbers winNumbers = new LottoNumbers(Stream.of(1, 2, 3, 4, 5, 6).map(LottoNumber::of).collect(Collectors.toSet()));
        ...
        LottoRanks ranks = lottoTickets.ranks(winNumbers, LottoNumber.of(34));
