...
public class PrizeStatusTest {
    ...
    public void createPrizeStatusInstance(long expected) {
        //Given
    ...
    public void equalsTest(long prizeNumber, long prizeNumber2, long prizeNumber3){
        //Given && When
    ...
    @ParameterizedTest
    @CsvSource(value = {"1:1:1", "3:3:3", "5:5:5"} , delimiter = ':')
    public void hashcodeTest(long prizeNumber, long prizeNumber2, long prizeNumber3) {
        //Given && When
