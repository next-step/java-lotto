...
public class CalculatorTest {
    ...
    void 덧셈() {
        Calculator calculator = new Calculator(new Expression(new ArrayList<>(List.of("2", "+", "3"))));
    ...
    void 뺄셈() {
        Calculator calculator = new Calculator(new Expression(new ArrayList<>(List.of("3", "-", "2" ))));
    ...
    void 나눗셈() {
        Calculator calculator = new Calculator(new Expression(new ArrayList<>(List.of( "4", "/", "2" ))));
    ...
    void 나눗셈_반올림() {
        Calculator calculator = new Calculator(new Expression(List.of("3", "/", "2" )));
        assertThat(calculator.calculate()).isEqualTo(1);
    }
}
