...
//        LottoResult lottoResult = new LottoResult(lotteryNumbersString, Collections.singletonList(lotto));
//
//        double expectedIncomeRate = getExpectedIncomeRate(1, 3);
//        assertThat(lottoResult.computeIncomeRate()).isEqualTo(expectedIncomeRate);
//    }
//
