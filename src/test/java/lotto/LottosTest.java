...
class LottosTest {
    ...
    class count {
        ...
        void countLotto() {
            ...
            assertThat(result.countByMatch(3)).isEqualTo(1);
            assertThat(result.countByMatch(4)).isEqualTo(1);
            assertThat(result.countByMatch(5)).isEqualTo(1);
            assertThat(result.countByMatch(6)).isEqualTo(1);
        }
        ...
        void notCountLotto() {
            ...
            assertThat(result.countByMatch(1)).isZero();
            assertThat(result.countByMatch(2)).isZero();
        }
    }
}
