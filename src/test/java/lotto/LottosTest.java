...
public class LottosTest {
    ...
    public static final Lottos TEST_LOTTO = new Lottos(Lists.newArrayList(ONE, TWO, THREE, FOUR, FIVE, SIX));
    ...
    void sizeTest() {
        Assertions.assertThatThrownBy(() -> new Lottos(Lists.newArrayList(ONE, TWO, THREE)))
    ...
    void resultMatchTest() {
        Lottos winLottoNums = new Lottos(Lists.newArrayList(ONE, TWO, THREE, FOUR, FIVE, SIX));
