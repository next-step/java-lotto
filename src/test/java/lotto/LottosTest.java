...
public class LottosTest {
    ...
    static Stream<Arguments> countLottosCollectNumber() {
        return Stream.of(
                Arguments.of(Arrays.asList(1, 2, 3, 4, 5, 6), "2,1,6,4,3,5", FIRST, 1, new LottoBonusNumber(2)),
                Arguments.of(Arrays.asList(1, 2, 3, 4, 5, 6), "2,1,8,9,3,7", FIRST, 0, new LottoBonusNumber(2)),
                Arguments.of(Arrays.asList(1, 2, 3, 4, 5, 6), "10,1,4,5,3,6", SECOND, 1, new LottoBonusNumber(2)),
                Arguments.of(Arrays.asList(1, 2, 3, 4, 5, 6), "10,1,4,5,3,6", THIRD, 0, new LottoBonusNumber(2)),
                Arguments.of(Arrays.asList(1, 2, 3, 4, 5, 6), "10,1,4,5,3,6", THIRD, 1, new LottoBonusNumber(11))
        );
    }
}
