...
public class WinningCheckerTest {
    ...
    void winningAndStatisticTest(List<Lotto> boughtLottos, double expectedEarningRate) {
    ...
    private static Stream<Arguments> boughtLottos() {
        return Stream.of(
                Arguments.of(lottosEarningZero(), 0),
                Arguments.of(lottosEarningMax(), WinningRank.MATCHES_SIX.winningAmount / LottoFactory.PRICE_OF_ONE_LOTTO)
        );
    }
