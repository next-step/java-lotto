...
public class LottoShopTest {
    ...
    void 로또를_장당_천원에_구매할_수_있다(int money, int count) {
        assertThat(new LottoShop().sellLotto(money).getLottoQuantity()).isEqualTo(count);
    }

    @Test
    void 로또를_구매할_떄_0_미만의_돈을_입력하면_예외가_발생한다() {
        assertThatThrownBy(() -> new LottoShop().sellLotto(-2000)).isInstanceOf(IllegalArgumentException.class);
    }
}
