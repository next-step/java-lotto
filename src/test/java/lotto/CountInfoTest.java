...
public class CountInfoTest {
    ...
    void CountInfoNullTest() {
        assertThatThrownBy(() -> new CountInfo(null, 3))
    ...
    void CountInfoNegativeTest() {
        assertThatThrownBy(() -> new CountInfo(new Money(1000), -1))
    ...
    void moneyUnitTest() {
        assertThatThrownBy(() -> new CountInfo(new Money(12345), 3))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void CountInfoTest() {
        CountInfo countInfo = new CountInfo(new Money(14000), 3);

        assertThat(countInfo.getRandomCount()).isEqualTo(11);
        assertThat(countInfo.getManualCount()).isEqualTo(3);
    }

    @Test
    @DisplayName("수동 구매 개수가 총 구매 가능한 개수보다 많으면 예외가 발생한다.")
    void manualCountTest() {
        assertThatThrownBy(() -> new CountInfo(new Money(14000), 15))
                .isInstanceOf(IllegalArgumentException.class);
    }
}
