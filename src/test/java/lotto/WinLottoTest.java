...
public class WinLottoTest {
    ...
    void 당첨_로또() {
        assertThatCode(() -> {
            new WinLotto(new LottoTicket(new LottoNumbers(List.of(1, 2, 3, 4, 5, 6))), LottoNumber.of(45));
    ...
    void 이미_있는_로또_번호() {
        assertThatExceptionOfType(AlreadyExistLottoNumberException.class)
                .isThrownBy(() -> new WinLotto(new LottoTicket(new LottoNumbers(List.of(1, 2, 3, 4, 5, 6))), LottoNumber.of(6)))
