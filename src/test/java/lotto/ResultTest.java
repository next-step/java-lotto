...
public class ResultTest {
    ...
    @Test
    void 당첨결과_테스트() {
        Result result = new Result(lottos, LottoFactory.newInstance("1,2,3,7,8,9"), BonusBall.of("10"));
    ...
    @Test
    void 당첨결과_2등_테스트() {
        Result result = new Result(lottos, LottoFactory.newInstance("1,2,3,4,5,9"), BonusBall.of("6"));
        Map<Rank, Integer> sampleResult = new HashMap<>();
