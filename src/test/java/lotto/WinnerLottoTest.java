...
public class WinnerLottoTest {
    ...
    void IsNumberOfWinningLottoIsEqualWithRealLottoResult(List<Lotto> input, List<Prize> expected) {
    ...
    private static Stream<Arguments> provideLottos() {
        return Stream.of(
                ...
                Arguments.of(Arrays.asList(
                        new Lotto(Arrays.asList(1,2,3,4,5,6)),
                        new Lotto(Arrays.asList(1,2,3,4,5,20)),
                        new Lotto(Arrays.asList(1,2,3,4,20,30))),
