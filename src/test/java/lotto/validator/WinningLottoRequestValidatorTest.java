...
public class WinningLottoRequestValidatorTest {
    ...
    void exceptionTest1(String numbers) {
        WinningLottoRequest winningLottoRequest = WinningLottoRequest.of(LottoNumberRequest.of(numbers), 10);
    ...
    void exceptionTest2(int bonusNumber) {
        WinningLottoRequest winningLottoRequest = WinningLottoRequest.of(LottoNumberRequest.of("1, 2, 3, 4, 5, 6"), bonusNumber);
    ...
    void exceptionTest3() {
        WinningLottoRequest winningLottoRequest = WinningLottoRequest.of(LottoNumberRequest.of("1, 2, 3, 4, 5, 6"), 6);
