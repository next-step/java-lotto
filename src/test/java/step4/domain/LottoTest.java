...
public class LottoTest {
  ...
  void matchingResultTest(String boughtNum, String answerNum, int result) {
    Lotto boughtLotto = new Lotto(LottoNumbers.convertStringToLottoNumbers(boughtNum));
    Lotto pickedLotto = new Lotto(LottoNumbers.convertStringToLottoNumbers(answerNum));
