...
class WinningTest {
    ...
    static Stream<Arguments> generateData() {
        ...
        firstLotteries.keep(step3.domain.Lottery.of(first));
        secondLotteries.keep(step3.domain.Lottery.of(second));
        thirdLotteries.keep(step3.domain.Lottery.of(third));
        fourthLotteries.keep(step3.domain.Lottery.of(fourth));
