...
class StringPlusCalculatorTest {
    ...
    @ParameterizedTest
    @NullSource
    public void givenNull_thenReturnZero(String input) {
    ...
    @ParameterizedTest
    @EmptySource
    public void givenEmpty_thenReturnZero(String input) {
        assertThat(spc.sumStringByDelimiter(input)).isZero();
    }
    ...
    public void givenStringOne_thenReturnSelf(String input) {
    ...
    public void givenSingleDelimiter_thenReturnSum(String input, int expected) {
    ...
    public void givenMultiDelimiter_thenReturnSum(String input, int expected) {
        assertThat(spc.sumStringByDelimiter(input)).isEqualTo(expected);
    }

    @DisplayName("“//”와 “\\n” 문자 사이에 커스텀 구분자를 지정할 수 있다")
    @Test
    public void givenCustomDelimiter_thenReturnSum() {
        assertThat(spc.sumStringByDelimiter("//;\n1;2;3")).isEqualTo(6);
    }

    @DisplayName("음수를 전달할 경우 RuntimeException 예외가 발생해야 한다")
    @Test
    public void givenNegative_thenThrowException() {
