...
public class StringPlusCalculatorTest {
    ...
    void 문자열_덧셈_기본_구분자_테스트(String input, int expected) {
        assertThat(stringPlusCalculator.calculate(input)).isEqualTo(expected);
    }
    ...
    @MethodSource("generateCustomInputAndResultArgument")
    @ParameterizedTest
    ...
    private static Stream<Arguments> generateCustomInputAndResultArgument(){
        return Stream.of(
                Arguments.of("//;\n1;2;3", 6),
                Arguments.of("//,\n1,2,3", 6),
                Arguments.of("//=\n1=3", 4)
