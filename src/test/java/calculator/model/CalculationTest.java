...
class CalculationTest {
	...
	public void stringArrayToList() {
		Calculation calculation = new Calculation();
		String[] commaSplitResult = calculation.notSpecialSplit("1,2,3,4:5");
		List<String> characters = calculation.StringArrayToList(commaSplitResult);
	...
	public void validNumberCheck() {
		...
		assertThrows(IllegalArgumentException.class, () ->
			calculation.calculate(characters)
		);

		assertThatThrownBy(() -> calculation.calculate(characters))
	...
	public void plusCalculator() {
		...
		characters.add("3");
		characters.add("2");
		int result = calculation.calculate(characters);

		assertThat(result).isEqualTo(6);

		characters.add("4");
		int result2 = calculation.calculate(characters);
