...
public class SubtractExpressionTest {
    ...
    @Test
    public void 빼기_테스트(){
        Expression expression = new SubtractExpression(new NumberExpression(10),new NumberExpression(5));

        NumberExpression calc = expression.calc();

        assertThat(calc).isEqualTo(new NumberExpression(10 - 5));
    }
    ...
    public void 연속된_빼기_테스트(){
        ...
        assertThat(calc).isEqualTo(new NumberExpression(10 - 5 - 5));
    }
