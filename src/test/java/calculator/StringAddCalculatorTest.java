...
class StringAddCalculatorTest {
    ...
    void splitAndSum_숫자하나(String text, int expectedResult) throws Exception {
    ...
    void splitAndSum_쉼표구분자(String text, int expectedResult) throws Exception {
        assertThat(StringAddCalculator.splitAndSum(text)).isEqualTo(expectedResult);
    }
    ...
    void splitAndSum_쉼표_또는_콜론_구분자(String text, int expectedResult) throws Exception {
        assertThat(StringAddCalculator.splitAndSum(text)).isEqualTo(expectedResult);
    }
    ...
    @ParameterizedTest
    @ValueSource(strings = {"//;\n1;2;3", "//@\n2@2@2", "//#\n1#1#2#2"})
    void splitAndSum_custom_구분자(String text) throws Exception {
    ...
    void splitAndSum_negative(String text) throws Exception {
