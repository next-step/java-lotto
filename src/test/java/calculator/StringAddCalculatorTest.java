...
class StringAddCalculatorTest {
    ...
    public void checkNullAndEmpty() throws Exception {
        int result = StringAddCalculator.splitAndSum(new Expression(null));
        assertThat(result).isEqualTo(0);

        result = StringAddCalculator.splitAndSum(new Expression(""));
        assertThat(result).isEqualTo(0);
    }
    ...
    public void checkOneLetter() throws Exception {
        int result = StringAddCalculator.splitAndSum(new Expression("1"));
