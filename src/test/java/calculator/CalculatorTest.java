...
class CalculatorTest {
    ...
    class calculate {
        ...
        void add() {
            String text = "1 + 3";
            assertThat(calculator.calculate(text)).isEqualTo(new Number(4));
        }
        ...
        void subtract() {
            String text = "3 - 1";
            assertThat(calculator.calculate(text)).isEqualTo(new Number(2));
        }
        ...
        void multiplyBy() {
            String text = "2 * 4";
            assertThat(calculator.calculate(text)).isEqualTo(new Number(8));
        }
