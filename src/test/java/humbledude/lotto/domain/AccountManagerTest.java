...
public class AccountManagerTest {
    ...
    private List<LottoNumberSet> tickets;
    ...
    public void setUp() {
        ...
        IntStream.range(0, 9)
                .forEach(i -> tickets.add(new LottoNumberSet(TestHelper.setOf(11, 12, 13, 14, 15, 16))));
    }
    ...
    public void profitRate() {
        ...
        tickets.add(new LottoNumberSet(TestHelper.setOf(1, 2, 3, 14, 15, 16)));
