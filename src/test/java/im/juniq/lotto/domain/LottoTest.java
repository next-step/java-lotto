...
class LottoTest {
    ...
    void prize() {
        ...
        assertThat(lotto.prize(new WinningNumbers(Arrays.asList(1, 2, 3, 4, 5, 7), 6)))
            .isEqualTo(Winning.SECOND.amount());
        assertThat(lotto.prize(new WinningNumbers(Arrays.asList(1, 2, 3, 4, 5, 7), 8)))
            .isEqualTo(Winning.THIRD.amount());
        assertThat(lotto.prize(new WinningNumbers(Arrays.asList(1, 2, 3, 4, 7, 8), 9)))
            .isEqualTo(Winning.FOURTH.amount());
        assertThat(lotto.prize(new WinningNumbers(Arrays.asList(1, 2, 3, 7, 8, 9), 10)))
            .isEqualTo(Winning.FIFTH.amount());
        assertThat(lotto.prize(new WinningNumbers(Arrays.asList(1, 2, 7, 8, 9, 10), 11)))
            .isEqualTo(Winning.LOSING.amount());
        assertThat(lotto.prize(new WinningNumbers(Arrays.asList(1, 7, 8, 9, 10, 11), 12)))
            .isEqualTo(Winning.LOSING.amount());
        assertThat(lotto.prize(new WinningNumbers(Arrays.asList(7, 8, 9, 10, 11, 12), 13)))
            .isEqualTo(Winning.LOSING.amount());
    }
}
