...
class LottoStatisticsKtTest {
    ...
    fun 당첨통계_0개일치_확인() {
        ...
        assertThat(jackpot).isEqualTo(RankKt.SAME_0_NUMBERS)
    }
    ...
    fun 당첨통계_3개일치_확인() {
        ...
        val jackpot = lottoStatistics.getJackpot(lottoNumbers)
        assertThat(jackpot).isEqualTo(RankKt.SAME_3_NUMBERS)
    }
    ...
    fun 당첨통계_4개일치_확인() {
        ...
        val jackpot = lottoStatistics.getJackpot(lottoNumbers)
        assertThat(jackpot).isEqualTo(RankKt.SAME_4_NUMBERS)
    }
    ...
    fun 당첨통계_5개일치_확인() {
        ...
        val jackpot = lottoStatistics.getJackpot(lottoNumbers)
        assertThat(jackpot).isEqualTo(RankKt.SAME_5_NUMBERS)
    }
    ...
    fun 당첨통계_6개일치_확인() {
        ...
        val jackpot = lottoStatistics.getJackpot(lottoNumbers)
        assertThat(jackpot).isEqualTo(RankKt.SAME_6_NUMBERS)
    }
}
