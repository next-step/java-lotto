...
* 화면
  ...
  - [x] 수동으로 구매한 로또 번호와 자동으로 구매한 로또 번호를 출력한다.(수동 구매 먼저)
* 로또
  - [x] 수동 구매 로또 번호를 생성한다.
  - [x] 전략패턴 제거
  - [x] 수동, 자동 복합 구매 기능
  - [x] 자동 구매 시 금액만으로 구매하도록 변경(전략패턴 제거)
  - [x] Money 생성자를 정적 팩토리 메소드로 변환
  - [x] Lottos 생성자를 정적 팩토리 메소드로 변환
* 피드백
  - [x] Lotto 생성자를 정적 팩토리 메소드로 변환
  - [x] static 메소드만 있는 클래스 private 생성자 추가
