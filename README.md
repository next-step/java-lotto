...
>### RequestedManualLottoNumbers (수동번호 목록 wrapping 객체)
>  - 수동갯수만큼의 수동번호 목록
>  - 수동 전략을 통해 로또 번호 목록을 생성.

>### ManualStrategy (LottoGenerateStrategy 구현체)
>  - 수동번호를 통해 로또번호를 생성하는 전략
>  - 수동 전략을 통해 로또 번호 목록을 생성.

>### LottoCounter (수동갯수 및 자동갯수 객체)
>  - 자동갯수를 금액과 수동갯수를 통해 관리함.
>  - 각 전략을 통해 LottoTickets 생성 요청.
---
## 기능 요구사항
