...
### 체크리스트 - 추가 요구사항
- [ ] 보너스 볼을 입력한다.
  - [ ] 당첨 넘버에 포함되지 않는 1~45까지의 수를 입력 받는다.
- [ ] Lotto 클래스에 보너스 넘버 상태를 추가하고, 보너스 넘버 계산 메서드를 추가한다.
  - [ ] 보너스 점수는 최고점보다 낮을때만 추가한다.
- [ ] LottoMachine과 PurchasedLottos에서 보너스 넘버를 계산하는 메서드를 호출한다.
