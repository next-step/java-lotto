...
* [ ] 국가코드 열거타입으로 변경
* [ ] enum 마지막 콤마삭제
* [ ] 생성자 안에는 최대한 비즈니스 로직을 제거하고 필요한 경우 정적 팩토리 함수 사용하가(Lotto)
* [ ] 하나 이상의 중간연산자가 있는 경우 시퀀스 사용
* [ ] 열거타입 map 사용할 때 hashmap-> enummap 활용해보기
* [ ] 구매가능 티켓 리턴 메소드 명칭 buyTickets 대신 더 명확하게 바꿔보기
* [ ] 객체화가 필요없는 싱글턴 객체 ->  생성자 제한
* [ ] '예외' 대신 던져진다(throw)는 표현으로 변경하기
* [ ] 1등 이외의 등수 테스트
* [ ] 로또 가격 이하 금액 input 테스트
* 
