...
- [x] 수동으로 구매할 로또 수를 입력한다.
  - [x] 로또 유효성 검증을 통과하지 못할경우 IllegalArgumentException 예외를 던진다.
- [x] 수동으로 구매할 번호를 입력한다.
  - [x] 1~45까지의 수 6개를 수동으로 구매할 로또 수만큼 입력 받는다. 그외 케이스는 모두 IllegalArgumentException 예외를 던진다.
- [x] 자동으로 구매할 로또의 개수는 얼마인지 계산한다.
- [x] 수동으로 구매할 번호를 저장한다.
- [x] 수동으로 N장, 자동으로 N개를 구매했습니다. 문자열을 출력한다.
  - [x] 수동으로 구매한 로또를 먼저 출력한다.
