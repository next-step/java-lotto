...
- [ ] 로또 구매자(LottoBuyer)는 일정 금액으로 로또를 LottoShop에서 구매할 수 있다.
  - [ ] 구매자는 일정 금액을 소지할 수 있다.
  - [ ] 처음 로또는 0개 가지고 있다.
  - [ ] 금액 만큼의 로또를 LottoShop으로 부터 구매할 수 있다.
- [ ] 로또를 판매하는 가게(LottoShop)는 자동으로 숫자를 찍어내 금액만큼 만들어 로또 구매자(LottoBuyer)에게 전달해준다.
  - [ ] LottoShop은 LottoBuyer가 제시한 금액만큼의 로또를 전달해준다.
