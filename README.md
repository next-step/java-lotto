...
## TODO
* [ ] Lotto 도메인 객체를 만든다. 들어온 숫자배열에 대해 검증을 해야한다. (배열은 size 6, 요소는 1~45 사이의 숫자인지)
* [ ] LottoMachine 도메인 객체를 만든다. 구입금액을 입력받고 횟수에 따른 List<Lotto>를 생성/반환 (구입금액에 대한 유효성 검사) (배열은 size 6, 요소는 1~45 사이의 숫자, )
