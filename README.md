...
## step3 보완점
* [ ] Lotto 생성자 생성시 list가 아닌 set으로 생성하기
* [ ] 테스트코드에서만 사용하는 프로덕션 코드 제거
* [ ] 가변인수 관련 내용..!
* [ ] 생성자에 있는 비즈니스 로직(안티패턴) 제거, 정적팩토리메소드 확인
* [ ] stream size 함수 활용
* [ ] 스트림함수 contains 활용해서 역할 위임하기
* [ ] 한줄 분기문{}, IDE에 의한 자동생성된 형태여도 주의하기! (가독성, 일관성 저하)
* [ ] dot(.)이 너무 많이 사용되는 경우 지역변수 활용하기
* [ ] for문 안에 if문, indent 규칙 검토
* [ ] NPE 위험이 있는 경우 반대로 표현하기
* [ ] sys.out이 많아지는 경우 다른 방법(stringbuilder 등) 활용하기