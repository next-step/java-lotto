...
### 기능 구현 목록
- [x] 수동 로또 구매
  - [x] '수동으로 구매할 로또 수를 입력해 주세요.' 란 문구가 출력 되며 수동 구매할 로또의 수를 사용자에게 입력 받는다.
  - [x] '수동으로 구매할 번호를 입력해 주세요.' 란 문구가 출력 되며 수동 구매할 로또의 번호를 사용자에게 로또 게임 별로 입력 받는다.
  - [x] 수동으로 구매한 로또와 자동으로 구매한 로또를 종합한다.
  - [x] 수동/자동 구매 방법 별 로또 구매 결과를 다음 포맷으로 출력한다. (포맷: 수동으로 %d장, 자동으로 %d개를 구매했습니다.)