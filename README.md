...
## 로또 기능 목록
### TODO
* 사용자가 수동으로 구매할 로또 수를 입력하면 수동 구매 로또 수만큼 수동 번호를 입력 받아 로또를 생성한다.
* 사용자가 입력한 로또 구입금액에서 수동으로 구매할 로또 금액을 검증한다.
* 사용자가 입력한 로또 구입금액에서 수동 구매 로또 수를 뺀만큼 자동으로 로또 번호를 생성해서 로또를 생성한다.
