...
- [x] 로또 발행 머신은 구입 금액에 해당하는 로또 티켓 N장을 발급해야 한다.
- [x] 로또 발행 머신은 구입 금액을 장당 가격으로 나누었을 때, 정수가 아니면 에러를 반환한다.
- [x] 로또 발행 머신은 지난주 당첨번호를 입력하면 N개의 번호가 일치하는 티켓 개수와 상금을 각각 반환한다.
- [ ] 로또 발행 머신은 총수익률을 반환한다.
